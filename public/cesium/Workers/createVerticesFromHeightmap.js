...
import { a as ar, c as sr } from "./chunk-DDOE447E.js";
import { a as ir } from "./chunk-RCKN2G6K.js";
import { a as xe } from "./chunk-ZBAXXYBT.js";
import { a as nr } from "./chunk-PQTWLWR6.js";
import "./chunk-SXFPISI4.js";
import "./chunk-HCBOUAOS.js";
import { a as tr } from "./chunk-LXB5W3RT.js";
import "./chunk-Q2AGSIFJ.js";
import "./chunk-4XQS6KUO.js";
import { c as rr } from "./chunk-VPJRLZMB.js";
import "./chunk-635BMVFD.js";
import { i as er, j as ne } from "./chunk-Y7Z6CVXH.js";
import { b as Ie } from "./chunk-HHFPYI7Q.js";
import "./chunk-SSZI3JCE.js";
import "./chunk-LP5YXEIX.js";
import { a as Re } from "./chunk-AMKKUAL3.js";
import { b as Pe, c as pe } from "./chunk-WORPNHJT.js";
import { a as re } from "./chunk-SWCW4GSU.js";
import { a as he } from "./chunk-PZM5FOOW.js";
import { a as me } from "./chunk-3MNKUQ6L.js";
import { c as Ir, d as xr, f as W } from "./chunk-J4SK6SKL.js";
var ur = Ir((Zr, Ue) => {
        ...
        ((A.defaultNoDataValue = -34027999387901484e22),
          (A.decode = function (r, a) {
            ...
            return (
              ...
              a.returnFileInfo &&
                ((u.fileInfo = b(i)), a.computeUsedBitDepths && (u.fileInfo.bitDepths = Y(i))),
              u
            );
          }));
          ...
          V = {
            ...
            readHeaderInfo: function (n, e) {
              ...
              if (
                ...
                throw (
                  "Unexpected file identifier string (expect Lerc2 ): " + t.fileIdentifierString
                );
              r += 6;
            ...
            readTiles: function (n, e, r) {
              ...
              for (c = 0; c < l; c++)
                for (v = c !== l - 1 ? o : Te, g = 0; g < m; g++)
                  for (
                    U = g !== m - 1 ? o : ke, w = c * t * o + g * o, d = t - U, ie = 0;
                    ie < le;
                    ie++
                  ) {
                    if (
                      (le > 1 && (j = new r(e.pixels.resultPixels.buffer, t * i * ie * u, t * i)),
                    ...
                    else if (((e.ptr += p), V.decodeBits(n, e, _, z, ie), (p = 0), Z))
                      for (f = 0; f < v; f++) {
...
G.computeVertices = function (D) {
  ...
  if (!W(D.width) || !W(D.height)) throw new me("options.width and options.height are required.");
  if (!W(D.nativeRectangle)) throw new me("options.nativeRectangle is required.");
  ...
  let hr = rr.fromPoints(ge),
    Ze;
  W(m) && (Ze = nr.fromRectangle(m, Q, z, o));
  let je;
  v && (je = new ar(o).computeHorizonCullingPointPossiblyUnderEllipsoid(g, ge, Q));
  let gr = new tr(se, fe, g),
    Ae = new sr(g, gr, ye, z, le, !1, U, k, M, S),
    qe = new Float32Array(te * Ae.stride),
    We = 0;
  for (let H = 0; H < te; ++H) We = Ae.encode(qe, We, ge[H], Xe[H], Ye[H], void 0, _e[H], ze[H]);
  return {
    vertices: qe,
    maximumHeight: z,
    minimumHeight: Q,
...
function yr(D, ae) {
  if (D.encoding === or.LERC) {
    ...
    if (A.statistics[0].minValue === Number.MAX_VALUE) throw new Re("Invalid tile data");
    ((D.heightmap = A.pixels[0]), (D.width = A.width), (D.height = A.height));
  }
  ((D.ellipsoid = pe.clone(D.ellipsoid)), (D.rectangle = ne.clone(D.rectangle)));
