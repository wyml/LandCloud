...
import { d as j } from "./chunk-WORPNHJT.js";
import { c as g } from "./chunk-SWCW4GSU.js";
import { a as i } from "./chunk-PZM5FOOW.js";
import { b as C } from "./chunk-3MNKUQ6L.js";
import { f as O } from "./chunk-J4SK6SKL.js";
function a(n, r, o) {
  return (
    o < 0 && (o += 1),
    o > 1 && (o -= 1),
    o * 6 < 1 ? n + (r - n) * 6 * o : o * 2 < 1 ? r : o * 3 < 2 ? n + (r - n) * (2 / 3 - o) * 6 : n
  );
}
var e = class n {
    constructor(r, o, t, f) {
      ((this.red = r ?? 1), (this.green = o ?? 1), (this.blue = t ?? 1), (this.alpha = f ?? 1));
    }
    static fromCartesian4(r, o) {
      return (
        C.typeOf.object("cartesian", r),
        O(o)
          ? ((o.red = r.x), (o.green = r.y), (o.blue = r.z), (o.alpha = r.w), o)
          : new n(r.x, r.y, r.z, r.w)
      );
    }
    static fromBytes(r, o, t, f, s) {
      return (
        (r = n.byteToFloat(r ?? 255)),
        (o = n.byteToFloat(o ?? 255)),
        (t = n.byteToFloat(t ?? 255)),
        (f = n.byteToFloat(f ?? 255)),
        O(s) ? ((s.red = r), (s.green = o), (s.blue = t), (s.alpha = f), s) : new n(r, o, t, f)
      );
    }
    static fromAlpha(r, o, t) {
      return (
        C.typeOf.object("color", r),
        C.typeOf.number("alpha", o),
        O(t)
          ? ((t.red = r.red), (t.green = r.green), (t.blue = r.blue), (t.alpha = o), t)
          : new n(r.red, r.green, r.blue, o)
      );
    }
    static fromRgba(r, o) {
      return ((A[0] = r), n.fromBytes(m[0], m[1], m[2], m[3], o));
    }
    static fromHsl(r, o, t, f, s) {
      ...
      if (o !== 0) {
        ...
        let F = 2 * t - S;
        ((c = a(F, S, r + 1 / 3)), (b = a(F, S, r)), (E = a(F, S, r - 1 / 3)));
      }
      return O(s)
        ? ((s.red = c), (s.green = b), (s.blue = E), (s.alpha = f), s)
        : new n(c, b, E, f);
    }
    static fromRandom(r, o) {
      r = r ?? g.EMPTY_OBJECT;
      let t = r.red;
      if (!O(t)) {
        let b = r.minimumRed ?? 0,
          E = r.maximumRed ?? 1;
        (C.typeOf.number.lessThanOrEquals("minimumRed", b, E),
          (t = b + i.nextRandomNumber() * (E - b)));
      }
      let f = r.green;
      if (!O(f)) {
        let b = r.minimumGreen ?? 0,
          E = r.maximumGreen ?? 1;
        (C.typeOf.number.lessThanOrEquals("minimumGreen", b, E),
          (f = b + i.nextRandomNumber() * (E - b)));
      }
      let s = r.blue;
      if (!O(s)) {
        let b = r.minimumBlue ?? 0,
          E = r.maximumBlue ?? 1;
        (C.typeOf.number.lessThanOrEquals("minimumBlue", b, E),
          (s = b + i.nextRandomNumber() * (E - b)));
      }
      let c = r.alpha;
      if (!O(c)) {
        let b = r.minimumAlpha ?? 0,
          E = r.maximumAlpha ?? 1;
        (C.typeOf.number.lessThanOrEquals("minimumAlpha", b, E),
          (c = b + i.nextRandomNumber() * (E - b)));
      }
      return O(o)
        ? ((o.red = t), (o.green = f), (o.blue = s), (o.alpha = c), o)
        : new n(t, f, s, c);
    }
    static fromCssColorString(r, o) {
      (C.typeOf.string("color", r), O(o) || (o = new n()), (r = r.trim()));
      let t = n[r.toUpperCase()];
      if (O(t)) return (n.clone(t, o), o);
      let f = z.exec(r);
      return f !== null
        ...
        : ((f = R.exec(r)),
          f !== null
            ...
            : ((f = D.exec(r)),
              f !== null
                ? ((o.red = parseFloat(f[1]) / (f[1].substr(-1) === "%" ? 100 : 255)),
                  (o.green = parseFloat(f[2]) / (f[2].substr(-1) === "%" ? 100 : 255)),
                  (o.blue = parseFloat(f[3]) / (f[3].substr(-1) === "%" ? 100 : 255)),
    ...
    static byteToFloat(r) {
      return r / 255;
    }
    static floatToByte(r) {
      return r === 1 ? 255 : (r * 256) | 0;
    }
    static clone(r, o) {
      if (O(r))
        return O(o)
          ? ((o.red = r.red), (o.green = r.green), (o.blue = r.blue), (o.alpha = r.alpha), o)
          : new n(r.red, r.green, r.blue, r.alpha);
    }
    static equals(r, o) {
      return (
        r === o ||
    ...
    static equalsArray(r, o, t) {
      return r.red === o[t] && r.green === o[t + 1] && r.blue === o[t + 2] && r.alpha === o[t + 3];
    }
    clone(r) {
      return n.clone(this, r);
    }
    equals(r) {
      return n.equals(this, r);
    }
    equalsEpsilon(r, o) {
      return (
        this === r ||
    ...
    toCssColorString() {
      let r = n.floatToByte(this.red),
        o = n.floatToByte(this.green),
        t = n.floatToByte(this.blue);
      return this.alpha === 1 ? `rgb(${r},${o},${t})` : `rgba(${r},${o},${t},${this.alpha})`;
    }
    toCssHexString() {
      let r = n.floatToByte(this.red).toString(16);
      r.length < 2 && (r = `0${r}`);
      let o = n.floatToByte(this.green).toString(16);
      o.length < 2 && (o = `0${o}`);
      let t = n.floatToByte(this.blue).toString(16);
      if ((t.length < 2 && (t = `0${t}`), this.alpha < 1)) {
        let f = n.floatToByte(this.alpha).toString(16);
        return (f.length < 2 && (f = `0${f}`), `#${r}${o}${t}${f}`);
      }
      return `#${r}${o}${t}`;
    }
    toBytes(r) {
      let o = n.floatToByte(this.red),
        t = n.floatToByte(this.green),
        f = n.floatToByte(this.blue),
        s = n.floatToByte(this.alpha);
      return O(r) ? ((r[0] = o), (r[1] = t), (r[2] = f), (r[3] = s), r) : [o, t, f, s];
    }
    static bytesToRgba(r, o, t, f) {
      return ((m[0] = r), (m[1] = o), (m[2] = t), (m[3] = f), A[0]);
    }
    toRgba() {
      return n.bytesToRgba(
        n.floatToByte(this.red),
        n.floatToByte(this.green),
        n.floatToByte(this.blue),
        n.floatToByte(this.alpha),
      );
    }
    brighten(r, o) {
      return (
        C.typeOf.number("magnitude", r),
        C.typeOf.number.greaterThanOrEquals("magnitude", r, 0),
    ...
    withAlpha(r, o) {
      return n.fromAlpha(this, r, o);
    }
    static add(r, o, t) {
      return (
        C.typeOf.object("left", r),
        C.typeOf.object("right", o),
    ...
    static lerp(r, o, t, f) {
      return (
        C.typeOf.object("start", r),
        C.typeOf.object("end", o),
        C.typeOf.number("t", t),
        C.typeOf.object("result", f),
    ...
    static multiplyByScalar(r, o, t) {
      return (
        C.typeOf.object("color", r),
        C.typeOf.number("scalar", o),
        C.typeOf.object("result", t),
        (t.red = r.red * o),
        (t.green = r.green * o),
        (t.blue = r.blue * o),
...
j.supportsTypedArrays() &&
  ((l = new ArrayBuffer(4)), (A = new Uint32Array(l)), (m = new Uint8Array(l)));
