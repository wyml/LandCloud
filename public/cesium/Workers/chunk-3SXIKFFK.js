...
import { a as b } from "./chunk-3BERLVP2.js";
import { a as u } from "./chunk-ER474XE6.js";
import { a as O } from "./chunk-WF6KNLYB.js";
import { b as w, c as h, d as y } from "./chunk-VGKISNF5.js";
import { c as l } from "./chunk-VPJRLZMB.js";
import { a as p } from "./chunk-SSZI3JCE.js";
import { a as i, c as A } from "./chunk-SWCW4GSU.js";
import { a as d, b as c } from "./chunk-3MNKUQ6L.js";
...
f.fromAxisAlignedBoundingBox = function (r) {
  return (c.typeOf.object("boundingBox", r), new f({ minimum: r.minimum, maximum: r.maximum }));
};
  ...
  if (a.position && (a.st || a.normal || a.tangent || a.bitangent)) {
    if (
      ...
      ((t[0] = 0),
        ...
        (t[70] = -1),
        (t[71] = 0),
        (s.normal = new y({ componentDatatype: p.FLOAT, componentsPerAttribute: 3, values: t })));
    }
    if (a.st) {
      ...
      ((t[0] = 0),
        ...
        (t[46] = 0),
        (t[47] = 1),
        (s.st = new y({ componentDatatype: p.FLOAT, componentsPerAttribute: 2, values: t })));
    }
    if (a.tangent) {
      let t = new Float32Array(72);
      ((t[0] = 1),
        ...
        (t[70] = 0),
        (t[71] = 0),
        (s.tangent = new y({ componentDatatype: p.FLOAT, componentsPerAttribute: 3, values: t })));
    }
    if (a.bitangent) {
      let t = new Float32Array(72);
      ((t[0] = 0),
    ...
    ((e = new Float64Array(24)),
      ...
      (e[22] = m.y),
      (e[23] = m.z),
      (s.position = new y({ componentDatatype: p.DOUBLE, componentsPerAttribute: 3, values: e })),
      (n = new Uint16Array(36)),
      (n[0] = 4),
      (n[1] = 5),
      (n[2] = 6),
...
f.getUnitBox = function () {
  return (
    x(z) ||
      (z = f.createGeometry(
        f.fromDimensions({ dimensions: new i(1, 1, 1), vertexFormat: u.POSITION_ONLY }),
      )),
    z
  );
};
