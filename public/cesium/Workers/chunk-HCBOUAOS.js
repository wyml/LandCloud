...
import { a as P } from "./chunk-LXB5W3RT.js";
import { a as u, b as d } from "./chunk-Q2AGSIFJ.js";
import { a as j } from "./chunk-4XQS6KUO.js";
import { i as A } from "./chunk-Y7Z6CVXH.js";
import { a as _, b as h } from "./chunk-HHFPYI7Q.js";
import { b as l, c as g } from "./chunk-WORPNHJT.js";
import { a as e } from "./chunk-SWCW4GSU.js";
import { a as y, b as p } from "./chunk-3MNKUQ6L.js";
import { f as r } from "./chunk-J4SK6SKL.js";
var x = new _();
function s(n, t) {
  if ((p.defined("origin", n), (t = t ?? g.default), (n = t.scaleToGeodeticSurface(n)), !r(n)))
...
s.prototype.projectPointOntoPlane = function (n, t) {
  ...
  if ((r(i) || (e.negate(o.direction, o.direction), (i = d.rayPlane(o, this._plane, m))), r(i))) {
...
s.prototype.projectPointToNearestOnPlane = function (n, t) {
  ...
  let i = d.rayPlane(o, this._plane, m);
  r(i) || (e.negate(o.direction, o.direction), (i = d.rayPlane(o, this._plane, m)));
  let c = e.subtract(i, this._origin, i),
    a = e.dot(this._xAxis, c),
    f = e.dot(this._yAxis, c);
...
s.prototype.projectPointsToNearestOnPlane = function (n, t) {
  ...
  let o = n.length;
  t.length = o;
  for (let i = 0; i < o; i++) t[i] = this.projectPointToNearestOnPlane(n[i], t[i]);
  return t;
};
var C = new e();
