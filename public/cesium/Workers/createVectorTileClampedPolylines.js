...
import { a as J } from "./chunk-RCKN2G6K.js";
import { a as Y } from "./chunk-SXFPISI4.js";
import { a as B } from "./chunk-CVUC3Z4F.js";
import { c as X, j as W } from "./chunk-Y7Z6CVXH.js";
import "./chunk-HHFPYI7Q.js";
import "./chunk-SSZI3JCE.js";
import "./chunk-LP5YXEIX.js";
import "./chunk-AMKKUAL3.js";
import { a as k, c as _ } from "./chunk-WORPNHJT.js";
...
function ft(e, o, c, i) {
  ...
  let l = 0;
  for (let r = 0; r < A; r++) h[r] !== 1 && ((e[l] = e[r]), (o[l] = o[r]), (c[l] = c[r]), l++);
}
function ot(e) {
  let o = e * 8,
    c = o * 3,
...
var st = [
    0, 2, 6, 0, 6, 4, 0, 1, 3, 0, 3, 2, 0, 4, 5, 0, 5, 1, 5, 3, 1, 5, 7, 3, 7, 5, 4, 7, 4, 6, 7, 6,
    2, 7, 2, 3,
  ],
  j = st.length,
  tt = new t(),
...
function Pt(e, o) {
  ...
  (o.push(a.startEllipsoidNormals.buffer),
    ...
    o.push(N.buffer));
  let C = {
    indexDatatype: N.BYTES_PER_ELEMENT === 2 ? B.UNSIGNED_SHORT : B.UNSIGNED_INT,
    ...
    startFaceNormalAndVertexCornerIds: a.startFaceNormalAndVertexCornerIds.buffer,
  ...
  if (e.keepDecodedPositions) {
    ...
    (o.push(F.buffer, y.buffer),
      (C = X(C, { decodedPositions: F.buffer, decodedPositionOffsets: y.buffer })));
  }
  return C;
}
var Vt = J(Pt);
