...
import { a as be, c as Ne } from "./chunk-DDOE447E.js";
import { a as Ae } from "./chunk-RCKN2G6K.js";
import { a as ue } from "./chunk-PQTWLWR6.js";
import { a as ee } from "./chunk-SXFPISI4.js";
import "./chunk-HCBOUAOS.js";
import "./chunk-LXB5W3RT.js";
import "./chunk-Q2AGSIFJ.js";
import "./chunk-4XQS6KUO.js";
import { a as Ve } from "./chunk-CVUC3Z4F.js";
import { c as de } from "./chunk-VPJRLZMB.js";
import "./chunk-635BMVFD.js";
import { j as Se } from "./chunk-Y7Z6CVXH.js";
import "./chunk-HHFPYI7Q.js";
import "./chunk-SSZI3JCE.js";
import "./chunk-LP5YXEIX.js";
import "./chunk-AMKKUAL3.js";
import { a as Ie, b as Z, c as Ce } from "./chunk-WORPNHJT.js";
import { a as A } from "./chunk-SWCW4GSU.js";
import { a as N } from "./chunk-PZM5FOOW.js";
import { a as V, b as q } from "./chunk-3MNKUQ6L.js";
...
ne.clipTriangleAtAxisAlignedThreshold = function (n, h, o, i, s, e) {
  ...
  f(e) ? (e.length = 0) : (e = []);
  let g, w, c;
  h ? ((g = o < n), (w = i < n), (c = s < n)) : ((g = o > n), (w = i > n), (c = s > n));
  let p = g + w + c,
    d,
    u,
    r,
...
ne.computeLineSegmentLineSegmentIntersection = function (n, h, o, i, s, e, g, w, c) {
  ...
  let r = p / u,
    l = d / u;
  if (r >= 0 && r <= 1 && l >= 0 && l <= 1)
    return (f(c) || (c = new Z()), (c.x = n + r * (o - n)), (c.y = h + r * (i - h)), c);
};
var ie = ne;
var a = 32767,
  z = (a / 2) | 0,
...
function je(n, h) {
  ...
  for (t = 0, k = 0; t < Y; ++t, k += 2) {
    ...
    ((o && x >= z) || (!o && x <= z)) &&
      ((i && y >= z) || (!i && y <= z)) &&
      ((l[t] = W), c.push(x), p.push(y), d.push(L[t]), O && (u.push(F[k]), u.push(F[k + 1])), ++W);
  }
  let T = [];
  ...
  for (ce < xe && (ce += N.TWO_PI), t = 0; t < c.length; ++t)
    ((x = Math.round(c[t])),
      x <= s ? (me.push(t), (x = 0)) : x >= e ? (le.push(t), (x = a)) : (x = x * 2 + He),
      (c[t] = x),
      (y = Math.round(p[t])),
      y <= g ? (ge.push(t), (y = 0)) : y >= w ? (we.push(t), (y = a)) : (y = y * 2 + qe),
      (p[t] = y),
  ...
  let he = de.fromVertices(M, A.ZERO, 3, Qe),
    ...
    ve = new be(re).computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid(
      he.center,
      M,
      3,
      he.center,
  ...
  for (fe += p.length, t = 0; t < d.length; ++t) X[fe + t] = (a * (d[t] - U)) / Pe;
...
m.prototype.getNormalX = function () {
  return f(this.index) ? this.normalBuffer[this.index * 2] : ((K = Te(this, K)), K.x);
};
m.prototype.getNormalY = function () {
  return f(this.index) ? this.normalBuffer[this.index * 2 + 1] : ((K = Te(this, K)), K.y);
};
var S = [];
S.push(new m());
S.push(new m());
