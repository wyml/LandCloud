...
u(Object.create) && ((f.prototype = Object.create(Error.prototype)), (f.prototype.constructor = f));
...
n.typeOf.number.lessThanOrEquals = function (t, e, o) {
  if ((n.typeOf.number(t, e), e > o))
    throw new r(`Expected ${t} to be less than or equal to ${o}, actual value was ${e}`);
};
...
n.typeOf.number.greaterThanOrEquals = function (t, e, o) {
  if ((n.typeOf.number(t, e), e < o))
    throw new r(`Expected ${t} to be greater than or equal to ${o}, actual value was ${e}`);
};
...
n.typeOf.number.equals = function (t, e, o, i) {
  if ((n.typeOf.number(t, o), n.typeOf.number(e, i), o !== i))
    throw new r(`${t} must be equal to ${e}, the actual values are ${o} and ${i}`);
};
var l = n;
