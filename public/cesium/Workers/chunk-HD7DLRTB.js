...
import { a as Fa } from "./chunk-E2XJEVRT.js";
import { a as zb, b as Ja, c as Ha } from "./chunk-DDOE447E.js";
import { a as Ia } from "./chunk-ZBAXXYBT.js";
import { a as ra } from "./chunk-PQTWLWR6.js";
import { a as rb } from "./chunk-SXFPISI4.js";
import { a as Ca } from "./chunk-LXB5W3RT.js";
import { a as gb, b as ib } from "./chunk-Q2AGSIFJ.js";
import { b as db, c as pa } from "./chunk-VPJRLZMB.js";
import {
  a as Ra,
  b as _b,
  d as hb,
  ...
  i as Oa,
  j as xa,
} from "./chunk-Y7Z6CVXH.js";
import { b as J } from "./chunk-HHFPYI7Q.js";
import { a as tb } from "./chunk-SSZI3JCE.js";
import { a as Ba } from "./chunk-AMKKUAL3.js";
import { a as Y, b as R, c as Ea, d as nb } from "./chunk-WORPNHJT.js";
import { a as p, b as ya, c as fb } from "./chunk-SWCW4GSU.js";
import { a as L } from "./chunk-PZM5FOOW.js";
import { a as Aa, b as T } from "./chunk-3MNKUQ6L.js";
import { d as $b, f as Z } from "./chunk-J4SK6SKL.js";
var Be = (function () {
  var e =
  ...
  var c,
    o = WebAssembly.instantiate(u(e), {}).then(function (k) {
      ((c = k.instance),
        c.exports.__wasm_call_ctors(),
        c.exports.meshopt_encodeVertexVersion(1),
        c.exports.meshopt_encodeIndexVersion(1));
    });
  function u(k) {
    for (var s = new Uint8Array(k.length), h = 0; h < k.length; ++h) {
      var n = k.charCodeAt(h);
      s[h] = n > 96 ? n - 97 : n > 64 ? n - 39 : n + 4;
    }
    for (var t = 0, h = 0; h < k.length; ++h)
      s[t++] = s[h] < 60 ? i[s[h]] : (s[h] - 60) * 64 + s[++h];
  ...
  function w(k, s, h, n) {
    var t = c.exports.sbrk,
      a = t(s.length * 4),
      d = t(h * 4),
      f = new Uint8Array(c.exports.memory.buffer),
      r = g(s);
    (f.set(r, a), n && n(a, a, s.length, h));
    var l = k(d, a, s.length, h);
    f = new Uint8Array(c.exports.memory.buffer);
    var m = new Uint32Array(h);
    (new Uint8Array(m.buffer).set(f.subarray(d, d + h * 4)),
      r.set(f.subarray(a, a + s.length * 4)),
      t(a - t(0)));
    for (var y = 0; y < s.length; ++y) s[y] = m[s[y]];
    return [m, l];
  }
  function v(k, s, h, n) {
    var t = c.exports.sbrk,
      ...
      d = t(h * n),
      f = new Uint8Array(c.exports.memory.buffer);
    (f.set(g(s), d), k(a, d, h, n), (f = new Uint8Array(c.exports.memory.buffer)));
    var r = new Uint32Array(h);
    return (new Uint8Array(r.buffer).set(f.subarray(a, a + h * 4)), t(a - t(0)), r);
  }
  function x(k, s, h, n, t, a, d) {
    var f = c.exports.sbrk,
      r = f(s),
      l = f(n * t),
      m = new Uint8Array(c.exports.memory.buffer);
    m.set(g(h), l);
    var y = k(r, s, l, n, t, a, d),
      I = new Uint8Array(y);
    return (I.set(m.subarray(r, r + y)), f(r - f(0)), I);
  }
  function j(k) {
    for (var s = 0, h = 0; h < k.length; ++h) {
      var n = k[h];
      s = s < n ? n : s;
    }
    return s;
  ...
  function A(k, s) {
    ...
    var h = new Uint16Array(k.buffer, k.byteOffset, k.byteLength / 2);
    return new Uint32Array(h);
  }
  function F(k, s, h, n, t, a, d) {
    var f = c.exports.sbrk,
      r = f(h * n),
      l = f(h * a),
      m = new Uint8Array(c.exports.memory.buffer);
    (m.set(g(s), l), k(r, h, n, t, l, d));
    var y = new Uint8Array(h * n);
    return (y.set(m.subarray(r, r + h * n)), f(r - f(0)), y);
  }
  return {
    ready: o,
    supported: !0,
    reorderMesh: function (k, s, h) {
      (b(k instanceof Uint32Array || k instanceof Int32Array), b(!s || k.length % 3 == 0));
      var n = s
        ? h
          ? c.exports.meshopt_optimizeVertexCacheStrip
          : c.exports.meshopt_optimizeVertexCache
        : void 0;
      return w(c.exports.meshopt_optimizeVertexFetchRemap, k, j(k) + 1, n);
    },
    reorderPoints: function (k, s) {
      return (
        ...
        b(k.length % s == 0),
        b(s >= 3),
        v(c.exports.meshopt_spatialSortRemap, k, k.length / s, s * 4)
      );
    },
    encodeVertexBuffer: function (k, s, h) {
      (b(h > 0 && h <= 256), b(h % 4 == 0));
      var n = c.exports.meshopt_encodeVertexBufferBound(s, h);
      return x(c.exports.meshopt_encodeVertexBuffer, n, k, s, h);
    },
    encodeVertexBufferLevel: function (k, s, h, n, t) {
      (b(h > 0 && h <= 256),
        b(h % 4 == 0),
        b(n >= 0 && n <= 3),
        b(t === void 0 || t == 0 || t == 1));
      var a = c.exports.meshopt_encodeVertexBufferBound(s, h);
      return x(c.exports.meshopt_encodeVertexBufferLevel, a, k, s, h, n, t === void 0 ? -1 : t);
    },
    encodeIndexBuffer: function (k, s, h) {
      (b(h == 2 || h == 4), b(s % 3 == 0));
      var n = A(k, h),
        t = c.exports.meshopt_encodeIndexBufferBound(s, j(n) + 1);
      return x(c.exports.meshopt_encodeIndexBuffer, t, n, s, 4);
    },
    encodeIndexSequence: function (k, s, h) {
      b(h == 2 || h == 4);
      var n = A(k, h),
        t = c.exports.meshopt_encodeIndexSequenceBound(s, j(n) + 1);
      return x(c.exports.meshopt_encodeIndexSequence, t, n, s, 4);
    },
    encodeGltfBuffer: function (k, s, h, n, t) {
      var a = {
        ATTRIBUTES: this.encodeVertexBufferLevel,
        TRIANGLES: this.encodeIndexBuffer,
        INDICES: this.encodeIndexSequence,
      };
      return (b(a[n]), a[n](k, s, h, 2, t === void 0 ? 0 : t));
    },
    encodeFilterOct: function (k, s, h, n) {
      return (
        b(h == 4 || h == 8),
        b(n >= 2 && n <= 16),
        F(c.exports.meshopt_encodeFilterOct, k, s, h, n, 16)
      );
    },
    encodeFilterQuat: function (k, s, h, n) {
      return (
        b(h == 8),
        b(n >= 4 && n <= 16),
        F(c.exports.meshopt_encodeFilterQuat, k, s, h, n, 16)
      );
    },
    encodeFilterExp: function (k, s, h, n, t) {
      (b(h > 0 && h % 4 == 0), b(n >= 1 && n <= 24));
      var a = { Separate: 0, SharedVector: 1, SharedComponent: 2, Clamped: 3 };
      return (b(!t || t in a), F(c.exports.meshopt_encodeFilterExp, k, s, h, n, h, t ? a[t] : 1));
    },
    encodeFilterColor: function (k, s, h, n) {
      return (
        b(h == 4 || h == 8),
        b(n >= 2 && n <= 16),
        F(c.exports.meshopt_encodeFilterColor, k, s, h, n, 16)
      );
    },
  };
})();
var Ma = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var u = WebAssembly.validate(c) ? w(i) : w(e),
    b,
    g = WebAssembly.instantiate(u, {}).then(function (t) {
      ((b = t.instance), b.exports.__wasm_call_ctors());
    });
  function w(t) {
    for (var a = new Uint8Array(t.length), d = 0; d < t.length; ++d) {
      var f = t.charCodeAt(d);
      a[d] = f > 96 ? f - 97 : f > 64 ? f - 39 : f + 4;
    }
    for (var r = 0, d = 0; d < t.length; ++d)
      a[r++] = a[d] < 60 ? o[a[d]] : (a[d] - 60) * 64 + a[++d];
    return a.buffer.slice(0, r);
  }
  function v(t, a, d, f, r, l, m) {
    var y = t.exports.sbrk,
      I = (f + 3) & -4,
      H = y(I * r),
      E = y(l.length),
      N = new Uint8Array(t.exports.memory.buffer);
    N.set(l, E);
    var z = a(H, f, r, E, l.length);
    if ((z == 0 && m && m(H, I, r), d.set(N.subarray(H, H + f * r)), y(H - y(0)), z != 0))
      throw new Error("Malformed buffer data: " + z);
  }
  var x = {
      NONE: "",
  ...
  function k(t) {
    ...
    return (
      (a.object.onmessage = function (d) {
        var f = d.data;
        ((a.pending -= f.count), a.requests[f.id][f.action](f.value), delete a.requests[f.id]);
      }),
      a
    );
  }
  function s(t) {
    for (
      var a =
          ...
          v.toString() +
          n.toString(),
        d = new Blob([a], { type: "text/javascript" }),
      ...
      A[r] = k(f);
    for (var r = t; r < A.length; ++r) A[r].object.postMessage({});
    ((A.length = t), URL.revokeObjectURL(f));
  }
  function h(t, a, d, f, r) {
    for (var l = A[0], m = 1; m < A.length; ++m) A[m].pending < l.pending && (l = A[m]);
    return new Promise(function (y, I) {
      var H = new Uint8Array(d),
        E = ++F;
      ((l.pending += t),
        (l.requests[E] = { resolve: y, reject: I }),
        l.object.postMessage({ id: E, count: t, size: a, source: H, mode: f, filter: r }, [
          H.buffer,
        ]));
    });
  }
  function n(t) {
    ...
    self.ready.then(function (d) {
      ...
      try {
        ...
        (v(d, d.exports[a.mode], f, a.count, a.size, a.source, d.exports[a.filter]),
          self.postMessage({ id: a.id, count: a.count, action: "resolve", value: f }, [f.buffer]));
      } catch (r) {
        self.postMessage({ id: a.id, count: a.count, action: "reject", value: r });
      }
    });
  }
  return {
    ...
    decodeVertexBuffer: function (t, a, d, f, r) {
      v(b, b.exports.meshopt_decodeVertexBuffer, t, a, d, f, b.exports[x[r]]);
    },
    decodeIndexBuffer: function (t, a, d, f) {
      v(b, b.exports.meshopt_decodeIndexBuffer, t, a, d, f);
    },
    decodeIndexSequence: function (t, a, d, f) {
      v(b, b.exports.meshopt_decodeIndexSequence, t, a, d, f);
    },
    decodeGltfBuffer: function (t, a, d, f, r, l) {
      v(b, b.exports[j[r]], t, a, d, f, b.exports[x[l]]);
    },
    decodeGltfBufferAsync: function (t, a, d, f, r) {
      return A.length > 0
        ? h(t, a, d, j[f], x[r])
        : g.then(function () {
            var l = new Uint8Array(t * a);
            return (v(b, b.exports[j[f]], l, t, a, d, b.exports[x[r]]), l);
          });
    },
  };
})();
var Ce = (function () {
  ...
  function w(a, d, f, r) {
    var l = c.exports.sbrk,
      m = l(f * 4),
      y = l(f * r * 4),
      I = new Uint8Array(c.exports.memory.buffer);
    (I.set(g(d), y), a(m, y, f, r * 4), (I = new Uint8Array(c.exports.memory.buffer)));
    var H = new Uint32Array(f);
    return (new Uint8Array(H.buffer).set(I.subarray(m, m + f * 4)), l(m - l(0)), H);
  }
  function v(a, d, f) {
    var r = c.exports.sbrk,
      l = r(d.length * 4),
      m = r(f * 4),
      y = new Uint8Array(c.exports.memory.buffer),
      I = g(d);
    y.set(I, l);
    var H = a(m, l, d.length, f);
    y = new Uint8Array(c.exports.memory.buffer);
    var E = new Uint32Array(f);
    (new Uint8Array(E.buffer).set(y.subarray(m, m + f * 4)), r(l - r(0)));
    for (var N = 0; N < d.length; ++N) d[N] = E[d[N]];
    return [E, H];
  }
  function x(a) {
  ...
  function j(a, d, f, r, l, m, y, I, H) {
    var E = c.exports.sbrk,
      N = E(4),
      z = E(f * 4),
      K = E(l * m),
      M = E(f * 4),
      D = new Uint8Array(c.exports.memory.buffer);
    (D.set(g(r), K), D.set(g(d), M));
    var B = a(z, M, f, K, l, m, y, I, H, N);
    D = new Uint8Array(c.exports.memory.buffer);
    var U = new Uint32Array(B);
    g(U).set(D.subarray(z, z + B * 4));
    var C = new Float32Array(1);
    return (g(C).set(D.subarray(N, N + 4)), E(N - E(0)), [U, C[0]]);
  }
  function A(a, d, f, r, l, m, y, I, H, E, N, z, K) {
    var M = c.exports.sbrk,
      D = M(4),
      B = M(f * 4),
      U = M(l * m),
      C = M(l * I),
      ...
      G = M(f * 4),
      W = E ? M(l) : 0,
      S = new Uint8Array(c.exports.memory.buffer);
    (S.set(g(r), U), S.set(g(y), C), S.set(g(H), O), S.set(g(d), G), E && S.set(g(E), W));
    var _ = a(B, G, f, U, l, m, C, I, O, H.length, W, N, z, K, D);
    S = new Uint8Array(c.exports.memory.buffer);
    var V = new Uint32Array(_);
    g(V).set(S.subarray(B, B + _ * 4));
    var q = new Float32Array(1);
    return (g(q).set(S.subarray(D, D + 4)), M(D - M(0)), [V, q[0]]);
  }
  function F(a, d, f, r, l, m, y, I, H, E, N, z, K) {
    var M = c.exports.sbrk,
      D = M(4),
      B = M(l * m),
      U = M(l * I),
      ...
      O = M(f * 4),
      G = E ? M(l) : 0,
      W = new Uint8Array(c.exports.memory.buffer);
    (W.set(g(r), B), W.set(g(y), U), W.set(g(H), C), W.set(g(d), O), E && W.set(g(E), G));
    var S = a(O, f, B, l, m, U, I, C, H.length, G, N, z, K, D);
    ((W = new Uint8Array(c.exports.memory.buffer)),
      g(d).set(W.subarray(O, O + S * 4)),
      g(r).set(W.subarray(B, B + l * m)),
      g(y).set(W.subarray(U, U + l * I)));
    var _ = new Float32Array(1);
    return (g(_).set(W.subarray(D, D + 4)), M(D - M(0)), [S, _[0]]);
  }
  function k(a, d, f, r) {
    var l = c.exports.sbrk,
      m = l(f * r),
  ...
  function s(a, d, f, r, l, m, y, I) {
    var H = c.exports.sbrk,
      E = H(I * 4),
      N = H(f * r),
      z = l ? H(f * m) : 0,
      K = new Uint8Array(c.exports.memory.buffer);
    (K.set(g(d), N), l && K.set(g(l), z));
    var M = a(E, N, f, r, z, m, y, I);
    K = new Uint8Array(c.exports.memory.buffer);
    var D = new Uint32Array(M);
    return (g(D).set(K.subarray(E, E + M * 4)), H(E - H(0)), D);
  }
  function h(a, d, f, r, l, m, y, I, H) {
    var E = c.exports.sbrk,
      N = E(4),
      z = E(f * 4),
      K = E(l * m),
      M = E(f * 4),
      D = y ? E(l) : 0,
      B = new Uint8Array(c.exports.memory.buffer);
    (B.set(g(r), K), B.set(g(d), M), y && B.set(g(y), D));
    var U = a(z, M, f, K, l, m, D, I, H, N);
    B = new Uint8Array(c.exports.memory.buffer);
    var C = new Uint32Array(U);
    g(C).set(B.subarray(z, z + U * 4));
    var O = new Float32Array(1);
    return (g(O).set(B.subarray(N, N + 4)), E(N - E(0)), [C, O[0]]);
  }
  function n(a, d, f, r, l, m, y) {
    var I = c.exports.sbrk,
      H = I(f * 4),
      E = I(l * m),
      N = I(f * 4),
      z = new Uint8Array(c.exports.memory.buffer);
    (z.set(g(r), E), z.set(g(d), N));
    var K = a(H, N, f, E, l, m, y);
    z = new Uint8Array(c.exports.memory.buffer);
    var M = new Uint32Array(K);
    return (g(M).set(z.subarray(H, H + K * 4)), I(H - I(0)), M);
  }
  var t = {
    LockBorder: 1,
    Sparse: 2,
  ...
  return {
    ...
    compactMesh: function (a) {
      (b(
        ...
        b(a.length % 3 == 0));
      var d = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        f = v(c.exports.meshopt_optimizeVertexFetchRemap, d, x(a) + 1);
      if (a !== d) for (var r = 0; r < d.length; ++r) a[r] = d[r];
      return f;
    },
    generatePositionRemap: function (a, d) {
      return (
        b(a instanceof Float32Array),
        b(a.length % d == 0),
        b(d >= 3),
        w(c.exports.meshopt_generatePositionRemap, a, a.length / d, d)
      );
    },
    simplify: function (a, d, f, r, l, m) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(r % 3 == 0),
        b(l >= 0));
      for (var y = 0, I = 0; I < (m ? m.length : 0); ++I) (b(m[I] in t), (y |= t[m[I]]));
      var H = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        E = j(c.exports.meshopt_simplify, H, a.length, d, d.length / f, f * 4, r, l, y);
      return ((E[0] = a instanceof Uint32Array ? E[0] : new a.constructor(E[0])), E);
    },
    simplifyWithAttributes: function (a, d, f, r, l, m, y, I, H, E) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(d.length % f == 0),
        b(f >= 3),
        b(r instanceof Float32Array),
        b(r.length == l * (d.length / f)),
        b(l >= 0),
        b(y == null || y instanceof Uint8Array),
        b(y == null || y.length == d.length / f),
        b(I >= 0 && I <= a.length),
        b(I % 3 == 0),
        b(H >= 0),
        b(Array.isArray(m)),
        b(l >= m.length),
        b(m.length <= 32));
      for (var N = 0; N < m.length; ++N) b(m[N] >= 0);
      for (var z = 0, N = 0; N < (E ? E.length : 0); ++N) (b(E[N] in t), (z |= t[E[N]]));
      var K = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        M = A(
          c.exports.meshopt_simplifyWithAttributes,
          K,
          a.length,
          d,
          d.length / f,
      ...
      return ((M[0] = a instanceof Uint32Array ? M[0] : new a.constructor(M[0])), M);
    },
    simplifyWithUpdate: function (a, d, f, r, l, m, y, I, H, E) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
      ...
      var K = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        M = F(
          c.exports.meshopt_simplifyWithUpdate,
          K,
          a.length,
          d,
          d.length / f,
      ...
      if (a !== K) for (var N = 0; N < M[0]; ++N) a[N] = K[N];
      return M;
    },
    getScale: function (a, d) {
      return (
        ...
        b(a.length % d == 0),
        b(d >= 3),
        k(c.exports.meshopt_simplifyScale, a, a.length / d, d * 4)
      );
    },
    simplifyPoints: function (a, d, f, r, l, m) {
      return (
        b(a instanceof Float32Array),
        b(a.length % d == 0),
        b(d >= 3),
        ...
        r
          ? (b(r instanceof Float32Array),
            b(r.length % l == 0),
            b(l >= 3),
            b(a.length / d == r.length / l),
            s(c.exports.meshopt_simplifyPoints, a, a.length / d, d * 4, r, l * 4, m || 0, f))
          : s(c.exports.meshopt_simplifyPoints, a, a.length / d, d * 4, void 0, 0, 0, f)
      );
    },
    simplifySloppy: function (a, d, f, r, l, m) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(d.length % f == 0),
        b(f >= 3),
        b(r == null || r instanceof Uint8Array),
        b(r == null || r.length == d.length / f),
        b(l >= 0 && l <= a.length),
        b(l % 3 == 0),
        b(m >= 0));
      var y = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        I = h(c.exports.meshopt_simplifySloppy, y, a.length, d, d.length / f, f * 4, r, l, m);
      return ((I[0] = a instanceof Uint32Array ? I[0] : new a.constructor(I[0])), I);
    },
    simplifyPrune: function (a, d, f, r) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
      ...
      var l = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        m = n(c.exports.meshopt_simplifyPrune, l, a.length, d, d.length / f, f * 4, r);
...
var Te = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var c,
    o = WebAssembly.instantiate(u(e), {}).then(function (h) {
      ((c = h.instance), c.exports.__wasm_call_ctors());
    });
  function u(h) {
    for (var n = new Uint8Array(h.length), t = 0; t < h.length; ++t) {
      var a = h.charCodeAt(t);
      n[t] = a > 96 ? a - 97 : a > 64 ? a - 39 : a + 4;
    }
    for (var d = 0, t = 0; t < h.length; ++t)
      n[d++] = n[t] < 60 ? i[n[t]] : (n[t] - 60) * 64 + n[++t];
    return n.buffer.slice(0, d);
  }
  function b(h) {
  ...
  var w = 48,
    v = 16;
  function x(h, n) {
    var t = h.meshlets[n * 4 + 0],
      a = h.meshlets[n * 4 + 1],
      d = h.meshlets[n * 4 + 2],
      f = h.meshlets[n * 4 + 3];
    return {
      vertices: h.vertices.subarray(t, t + d),
      triangles: h.triangles.subarray(a, a + f * 3),
    };
  }
  function j(h, n, t, a, d, f, r, l, m, y) {
    var I = c.exports.sbrk,
      H = c.exports.meshopt_buildMeshletsBound(n.length, f, r),
      E = I(H * v),
      N = I(n.length * 4),
      z = I(n.length),
      K = I(n.byteLength),
      M = I(t.byteLength),
      D = new Uint8Array(c.exports.memory.buffer);
    (D.set(g(n), K), D.set(g(t), M));
    var B = h(E, N, z, K, n.length, M, a, d, f, r, l, m, y);
    D = new Uint8Array(c.exports.memory.buffer);
    for (
      var U = D.subarray(E, E + B * v),
        C = new Uint32Array(U.buffer, U.byteOffset, U.byteLength / 4).slice(),
        O = 0;
      O < B;
      ++O
    ) {
      var G = C[O * 4 + 0],
        ...
        a = C[O * 4 + 2],
        S = C[O * 4 + 3];
      c.exports.meshopt_optimizeMeshlet(N + G * 4, z + W, S, a);
    }
    var _ = B ? C[(B - 1) * 4 + 0] + C[(B - 1) * 4 + 2] : 0,
      V = B ? C[(B - 1) * 4 + 1] + C[(B - 1) * 4 + 3] * 3 : 0,
      q = {
        meshlets: C,
        vertices: new Uint32Array(D.buffer, N, _).slice(),
        triangles: new Uint8Array(D.buffer, z, V).slice(),
        meshletCount: B,
      };
    return (I(E - I(0)), q);
  }
  function A(h) {
    var n = new Float32Array(c.exports.memory.buffer, h, w / 4);
    return {
      centerX: n[0],
      centerY: n[1],
      centerZ: n[2],
  ...
  function F(h, n, t, a) {
    var d = c.exports.sbrk,
      f = [],
      r = d(n.byteLength),
      l = d(h.vertices.byteLength),
      m = d(h.triangles.byteLength),
      y = d(w),
      I = new Uint8Array(c.exports.memory.buffer);
    (I.set(g(n), r), I.set(g(h.vertices), l), I.set(g(h.triangles), m));
    for (var H = 0; H < h.meshletCount; ++H) {
      var E = h.meshlets[H * 4 + 0],
        N = h.meshlets[H * 4 + 1],
        z = h.meshlets[H * 4 + 3];
      (c.exports.meshopt_computeMeshletBounds(y, l + E * 4, m + N, z, r, t, a), f.push(A(y)));
    }
    return (d(r - d(0)), f);
  }
  function k(h, n, t, a) {
    ...
    (m.set(g(h), r),
      m.set(g(n), l),
      c.exports.meshopt_computeClusterBounds(f, r, h.length, l, t, a));
    var y = A(f);
    return (d(f - d(0)), y);
  }
  function s(h, n, t, a, d) {
    var f = c.exports.sbrk,
      r = f(w),
      l = f(h.byteLength),
    ...
    (y.set(g(h), l),
      a && y.set(g(a), m),
      c.exports.meshopt_computeSphereBounds(r, l, n, t, m, a ? d : 0));
    var I = A(r);
    return (f(r - f(0)), I);
  }
  return {
    ready: o,
    supported: !0,
    buildMeshlets: function (h, n, t, a, d, f) {
      (b(h.length % 3 == 0),
        ...
        b(d >= 1 && d <= 512),
        (f = f || 0));
      var r = h.BYTES_PER_ELEMENT == 4 ? h : new Uint32Array(h);
      return j(c.exports.meshopt_buildMeshletsFlex, r, n, n.length / t, t * 4, a, d, d, f, 0);
    },
    buildMeshletsFlex: function (h, n, t, a, d, f, r, l) {
      (b(h.length % 3 == 0),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3),
        ...
        (r = r || 0),
        (l = l || 0));
      var m = h.BYTES_PER_ELEMENT == 4 ? h : new Uint32Array(h);
      return j(c.exports.meshopt_buildMeshletsFlex, m, n, n.length / t, t * 4, a, d, f, r, l);
    },
    buildMeshletsSpatial: function (h, n, t, a, d, f, r) {
      (b(h.length % 3 == 0),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3),
        ...
        b(d <= f),
        (r = r || 0));
      var l = h.BYTES_PER_ELEMENT == 4 ? h : new Uint32Array(h);
      return j(c.exports.meshopt_buildMeshletsSpatial, l, n, n.length / t, t * 4, a, d, f, r);
    },
    extractMeshlet: function (h, n) {
      return (b(n >= 0 && n < h.meshletCount), x(h, n));
    },
    computeClusterBounds: function (h, n, t) {
      (b(h.length % 3 == 0),
        b(h.length / 3 <= 512),
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3));
      var a = h.BYTES_PER_ELEMENT == 4 ? h : new Uint32Array(h);
      return k(a, n, n.length / t, t * 4);
    },
    computeMeshletBounds: function (h, n, t) {
      return (
        b(n instanceof Float32Array),
        b(n.length % t == 0),
        b(t >= 3),
        F(h, n, n.length / t, t * 4)
      );
    },
    computeSphereBounds: function (h, n, t, a) {
      return (
        ...
        b(!t || t.length % a == 0),
        b(!t || a >= 1),
        b(!t || h.length / n == t.length / a),
        (a = a || 0),
        s(h, h.length / n, n * 4, t, a * 4)
      );
    },
  };
})();
var Ge = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var c,
    o = WebAssembly.instantiate(u(e), {}).then(function (x) {
      ((c = x.instance), c.exports.__wasm_call_ctors());
    });
  function u(x) {
    for (var j = new Uint8Array(x.length), A = 0; A < x.length; ++A) {
      var F = x.charCodeAt(A);
      j[A] = F > 96 ? F - 97 : F > 64 ? F - 39 : F + 4;
    }
    for (var k = 0, A = 0; A < x.length; ++A)
      j[k++] = j[A] < 60 ? i[j[A]] : (j[A] - 60) * 64 + j[++A];
    return j.buffer.slice(0, k);
  }
  function b(x) {
  ...
  function w(x, j, A, F, k, s, h, n, t, a) {
    var d = c.exports.sbrk,
      f = d(j * 16),
      r = x ? d(x.byteLength) : 0,
      l = d(A.byteLength),
      m = d(s.byteLength),
      y = d(n.byteLength),
      I = new Uint8Array(c.exports.memory.buffer);
    (x && I.set(g(x), r),
      ...
      I.set(g(s), m),
      I.set(g(n), y),
      c.exports.meshopt_generateTangents(f, r, j, l, F, k * 4, m, h * 4, y, t * 4, a),
      (I = new Uint8Array(c.exports.memory.buffer)));
    var H = new Float32Array(I.buffer, f, j * 4).slice();
    return (d(f - d(0)), H);
  }
  var v = { Compatible: 1, ZeroFallback: 2 };
  return {
    ready: o,
    supported: !0,
    generateTangents: function (x, j, A, F, k, s, h, n) {
      (b(
        x === null ||
        ...
        b(x === null || x.length % 3 == 0),
        b(j instanceof Float32Array),
        b(j.length % A == 0),
        b(A >= 3),
        b(F instanceof Float32Array),
        b(F.length % k == 0),
        b(k >= 3),
        b(s instanceof Float32Array),
        b(s.length % h == 0),
        b(h >= 2),
        b(j.length / A == F.length / k),
        b(j.length / A == s.length / h),
        b(x !== null || (j.length / A) % 3 == 0));
      for (var t = 0, a = 0; a < (n ? n.length : 0); ++a) (b(n[a] in v), (t |= v[n[a]]));
      var d = j.length / A,
        f = x ? x.length : d,
        r = x === null || x.BYTES_PER_ELEMENT == 4 ? x : new Uint32Array(x);
      return w(r, f, j, d, A, F, k, s, h, t);
    },
  };
})();
var ma = { X: 0, Y: 1, Z: 2 };
ma.Y_UP_TO_Z_UP = J.fromRotationTranslation(ya.fromArray([1, 0, 0, 0, 0, 1, 0, -1, 0]));
ma.Z_UP_TO_Y_UP = J.fromRotationTranslation(ya.fromArray([1, 0, 0, 0, 0, -1, 0, 1, 0]));
ma.X_UP_TO_Z_UP = J.fromRotationTranslation(ya.fromArray([0, 0, 1, 0, 1, 0, -1, 0, 0]));
ma.Z_UP_TO_X_UP = J.fromRotationTranslation(ya.fromArray([0, 0, -1, 0, 1, 0, 1, 0, 0]));
ma.X_UP_TO_Y_UP = J.fromRotationTranslation(ya.fromArray([0, 1, 0, -1, 0, 0, 0, 0, 1]));
ma.Y_UP_TO_X_UP = J.fromRotationTranslation(ya.fromArray([0, -1, 0, 1, 0, 0, 0, 0, 1]));
ma.fromName = function (e) {
  return (T.typeOf.string("name", e), ma[e]);
};
Object.freeze(ma);
var Kb = ma;
var Ta = { MORPHING: 0, COLUMBUS_VIEW: 1, SCENE2D: 2, SCENE3D: 3 };
Ta.getMorphTime = function (e) {
  return e === Ta.SCENE3D ? 1 : e === Ta.MORPHING ? void 0 : 0;
};
Object.freeze(Ta);
var Ya = Ta;
var Bb = $b(_b(), 1);
...
function bc(e, i) {
  i = i ?? "This object was destroyed, i.e., destroy() was called.";
  function c() {
    throw new Aa(i);
  }
  for (let o in e) typeof e[o] == "function" && (e[o] = c);
  e.isDestroyed = ac;
}
var Db = bc;
function Rb() {
  if (!Z($._canTransferArrayBuffer)) {
    let e = lb("transferTypedArrayTest");
    e.postMessage = e.webkitPostMessage ?? e.postMessage;
    let i = 99,
      c = new Int8Array([i]);
    try {
      e.postMessage({ array: c }, [c.buffer]);
    } catch {
      return (($._canTransferArrayBuffer = !1), $._canTransferArrayBuffer);
    }
    $._canTransferArrayBuffer = new Promise((o) => {
      e.onmessage = function (u) {
        let b = u.data.array,
          g = Z(b) && b[0] === i;
        (o(g), e.terminate(), ($._canTransferArrayBuffer = g));
      };
    });
  }
  return $._canTransferArrayBuffer;
}
var mb = new Fb();
function ob(e) {
  let i;
  try {
    i = new Blob([e], { type: "application/javascript" });
  } catch {
    let u =
        window.BlobBuilder ||
      ...
      b = new u();
    (b.append(e), (i = b.getBlob("application/javascript")));
  }
  return (window.URL || window.webkitURL).createObjectURL(i);
}
function lb(e) {
  let i = new Bb.default(e),
    c = i.scheme().length !== 0 && i.fragment().length === 0,
    o = e.replace(/\.js$/, ""),
    u = {},
    b,
    g;
  if (hb(e)) g = e;
    ...
    let w = Na(`${$._workerModulePrefix}/${o}.js`);
    hb(w) && (g = w);
  }
  if (g) {
    let w = `import "${g}";`;
    return ((b = ob(w)), (u.type = "module"), new Worker(b, u));
  }
  if (!c && typeof CESIUM_WORKERS < "u") {
    let w = `
      importScripts("${ob(CESIUM_WORKERS)}");
      CesiumWorkers["${o}"]();
    `;
    return ((b = ob(w)), new Worker(b, u));
  }
  if (((b = e), c || (b = Na(`${$._workerModulePrefix + o}.js`)), !nb.supportsEsmWebWorkers()))
    throw new Ba("This browser is not supported. Please update your browser to continue.");
  return ((u.type = "module"), new Worker(b, u));
}
async function cc(e, i) {
  let c = { modulePath: void 0, wasmBinaryFile: void 0, wasmBinary: void 0 };
  if (!nb.supportsWebAssembly()) {
    if (!Z(i.fallbackModulePath))
      throw new Ba(
        `This browser does not support Web Assembly, and no backup module was provided for ${e._workerPath}`,
      );
    return ((c.modulePath = Na(i.fallbackModulePath)), c);
  }
  c.wasmBinaryFile = Na(i.wasmBinaryFile);
  let o = await Mb.fetchArrayBuffer({ url: c.wasmBinaryFile });
  return ((c.wasmBinary = o), c);
}
function $(e, i) {
  ((this._workerPath = e),
    (this._maximumActiveTasks = i ?? Number.POSITIVE_INFINITY),
    (this._activeTasks = 0),
    (this._nextID = 0),
...
var ec = (e, i, c, o) => {
    let u = ({ data: b }) => {
      if (b.id === i) {
        if (Z(b.error)) {
          let g = b.error;
          (g.name === "RuntimeError"
            ? ((g = new Ba(b.error.message)), (g.stack = b.error.stack))
            : g.name === "DeveloperError"
              ? ((g = new Aa(b.error.message)), (g.stack = b.error.stack))
              : g.name === "Error" && ((g = new Error(b.error.message)), (g.stack = b.error.stack)),
            mb.raiseEvent(g),
            o(g));
        } else (mb.raiseEvent(), c(b.result));
  ...
  dc = [];
async function fc(e, i, c) {
  let o = await Promise.resolve(Rb());
  Z(c) ? o || (c.length = 0) : (c = dc);
  let u = e._nextID++,
    b = new Promise((g, w) => {
      e._worker.addEventListener("message", ec(e._worker, u, g, w));
    });
  return (
    e._worker.postMessage(
      { id: u, baseUrl: Na.getCesiumBaseUrl().url, parameters: i, canTransferArrayBuffer: o },
      c,
    ),
    b
  );
}
async function hc(e, i, c) {
  ++e._activeTasks;
  try {
    let o = await fc(e, i, c);
    return (--e._activeTasks, o);
  } catch (o) {
    throw (--e._activeTasks, o);
  }
}
$.prototype.scheduleTask = function (e, i) {
  if (
    (Z(this._worker) || (this._worker = lb(this._workerPath)),
    !(this._activeTasks >= this._maximumActiveTasks))
  )
    return hc(this, e, i);
};
$.prototype.initWebAssemblyModule = async function (e) {
  if (Z(this._webAssemblyPromise)) return this._webAssemblyPromise;
  let i = async () => {
    let c = (this._worker = lb(this._workerPath)),
      o = await cc(this, e),
      u = await Promise.resolve(Rb()),
      b,
      g = o.wasmBinary;
    Z(g) && u && (b = [g]);
    let w = new Promise((v, x) => {
      c.onmessage = function ({ data: j }) {
        Z(j) ? v(j.result) : x(new Ba("Could not configure wasm module"));
      };
    });
    return (
      c.postMessage({ canTransferArrayBuffer: u, parameters: { webAssemblyConfig: o } }, b),
      w
    );
  };
  return ((this._webAssemblyPromise = i()), this._webAssemblyPromise);
};
$.prototype.isDestroyed = function () {
  return !1;
};
$.prototype.destroy = function () {
  return (Z(this._worker) && this._worker.terminate(), Db(this));
};
$.taskCompletedEvent = mb;
$._defaultWorkerModulePrefix = "Workers/";
$._workerModulePrefix = $._defaultWorkerModulePrefix;
$._canTransferArrayBuffer = void 0;
var Ob = $;
var nc = 3,
  kb = class {
    constructor(i, c, o) {
      (T.defined("vertices", i),
        T.defined("indices", c),
        T.defined("encoding", o),
        (this._vertices = i),
        (this._indices = c),
        (this._encoding = o),
        (this._inverseTransform = new J()),
    ...
    set needsRebuild(i) {
      this._needsRebuild = i;
    }
    rayIntersect(i, c, o, u, b) {
      this._needsRebuild && gc(this, c);
      let g = this._inverseTransform,
        w = rc;
      ((w.origin = J.multiplyByPoint(g, i.origin, w.origin)),
        (w.direction = J.multiplyByPointAsVector(g, i.direction, w.direction)));
      let v = [];
      return (Jb(this._rootNode, w, v), sc(this, v, i, o, u, b));
    }
  },
  tc = new Ob("incrementallyBuildTerrainPicker"),
  jb = class e {
    constructor() {
      ((this.x = 0),
        (this.y = 0),
        (this.level = 0),
        (this.aabb = Cb(this.x, this.y, this.level)),
    ...
    addChild(i) {
      if (i < 0 || i > 3)
        throw new Aa("TerrainPickerNode child index must be between 0 and 3, inclusive.");
      let c = new e();
      ((c.x = this.x * 2 + (i & 1)),
        (c.y = this.y * 2 + ((i >> 1) & 1)),
        (c.level = this.level + 1),
        (c.aabb = Cb(c.x, c.y, c.level)),
        (this.children[i] = c));
    }
  },
  rc = new gb(),
  Qa = [new p(), new p(), new p()];
function gc(e, i) {
  (J.inverse(i, e._inverseTransform), (e._needsRebuild = !1));
  let c = e._indices.length / 3,
    o = new Uint32Array(c);
  for (let u = 0; u < c; ++u) o[u] = u;
  ((e._rootNode.intersectingTriangles = o), (e._rootNode.children.length = 0));
}
var ic = new p(),
  oc = new p();
function Cb(e, i, c) {
  let o = 1 / Math.pow(2, c),
    u = p.fromElements(e * o - 0.5, i * o - 0.5, -0.5, ic),
    b = p.fromElements((e + 1) * o - 0.5, (i + 1) * o - 0.5, 0.5, oc);
  return Ca.fromCorners(u, b);
}
function mc(e, i, c, o, u) {
  (p.pack(c[0], e, 9 * u), p.pack(c[1], e, 9 * u + 3), p.pack(c[2], e, 9 * u + 6), (i[u] = o));
}
var lc = new db();
function Jb(e, i, c) {
  let o = ib.rayAxisAlignedBoundingBox(i, e.aabb, lc);
  if (!Z(o)) return;
  if (!e.children.length || e.buildingChildren) {
    c.push({ node: e, interval: new db(o.start, o.stop) });
    return;
  }
  for (let b = 0; b < e.children.length; b++) Jb(e.children[b], i, c);
}
function sc(e, i, c, o, u, b) {
  let g = i.sort(function (v, x) {
      return v.interval.start - x.interval.start;
    }),
    w = Number.MAX_VALUE;
  for (let v = 0; v < g.length; v++) {
    let x = g[v],
      j = kc(e, c, x.node, o, u, b);
    if (((w = Math.min(j, w)), w !== Number.MAX_VALUE)) break;
  }
  if (w !== Number.MAX_VALUE) return gb.getPoint(c, w);
}
function kc(e, i, c, o, u, b) {
  let g = Number.MAX_VALUE,
    w = e._encoding,
    v = e._indices,
    x = e._vertices,
    j = c.intersectingTriangles.length,
    F = !(c.level >= nc) && !c.buildingChildren,
    k,
    s;
  F && ((k = new Float64Array(j * 9)), (s = new Uint32Array(j)));
  for (let h = 0; h < j; h++) {
    let n = c.intersectingTriangles[h],
      t = sb(w, u, b, i, x, v[3 * n], Qa[0]),
      a = sb(w, u, b, i, x, v[3 * n + 1], Qa[1]),
      d = sb(w, u, b, i, x, v[3 * n + 2], Qa[2]),
      f = ib.rayTriangleParametric(i, t, a, d, o);
    (Z(f) && f < g && f >= 0 && (g = f), F && mc(k, s, Qa, n, h));
  }
  if (F) {
    for (let h = 0; h < 4; h++) c.addChild(h);
    uc(e._inverseTransform, c, s, k);
  }
  return g;
}
var jc = new Y();
function sb(e, i, c, o, u, b, g) {
  let w = e.getExaggeratedPosition(u, b, g);
  if (i === Ya.SCENE3D) return w;
  let x = c.ellipsoid.cartesianToCartographic(w, jc);
  ((w = c.project(x, g)), (w = p.fromElements(w.z, w.x, w.y, g)));
  let j = L.TWO_PI * c.ellipsoid.maximumRadius,
    A = Math.round((o.origin.y - w.y) / j);
  return ((w.y += A * j), w);
}
async function uc(e, i, c, o) {
  i.buildingChildren = !0;
  let u = new Float64Array(16);
  J.pack(e, u, 0);
  let b = new Float64Array(24);
  for (let j = 0; j < 4; j++)
    (p.pack(i.children[j].aabb.minimum, b, j * 6),
      p.pack(i.children[j].aabb.maximum, b, j * 6 + 3));
  let g = { aabbs: b, inverseTransform: u, triangleIndices: c, trianglePositions: o },
    w = [b.buffer, u.buffer, c.buffer, o.buffer],
    v = tc.scheduleTask(g, w);
  if (!Z(v)) {
    i.buildingChildren = !1;
    return;
  }
  ((await v).intersectingTrianglesArrays.forEach((j, A) => {
    Z(i.children[A]) && (i.children[A].intersectingTriangles = new Uint32Array(j));
  }),
    (i.intersectingTriangles = new Uint32Array(0)),
    (i.buildingChildren = !1));
}
var Tb = kb;
function Ua(e, i, c, o, u, b, g, w, v, x, j, A, F, k, s, h, n) {
  ((this.center = e),
    (this.vertices = i),
    (this.stride = j ?? 6),
    (this.indices = c),
    (this.indexCountWithoutSkirts = o),
    (this.vertexCountWithoutSkirts = u),
    (this.minimumHeight = b),
    (this.maximumHeight = g),
    (this.rectangle = w),
    (this.boundingSphere3D = v),
    (this.occludeePointInScaledSpace = x),
    (this.orientedBoundingBox = A),
    (this.encoding = F),
    (this.westIndicesSouthToNorth = k),
    (this.southIndicesEastToWest = s),
    (this.eastIndicesNorthToSouth = h),
    (this.northIndicesWestToEast = n),
    (this._transform = new J()),
    (this._lastPickSceneMode = void 0),
    (this._terrainPicker = new Tb(i, c, F)));
}
Ua.prototype.getTransform = function (e, i) {
  return this._lastPickSceneMode === e
    ? this._transform
    : ((this._terrainPicker.needsRebuild = !0),
      !Z(e) || e === Ya.SCENE3D ? wc(this, this._transform) : Ec(this, i, this._transform));
};
function wc(e, i) {
  let c = e.encoding.exaggeration,
    o = e.encoding.exaggerationRelativeHeight,
    u = Ja.getHeight(e.minimumHeight, c, o),
    b = Ja.getHeight(e.maximumHeight, c, o),
    g = ra.fromRectangle(e.rectangle, u, b, Ea.default, e.orientedBoundingBox);
  return (
    ra.computeTransformation(g, i),
    J.getScale(i, ub).z <= L.EPSILON16 && ((ub.z = 1), J.setScale(i, ub, i)),
    i
  );
}
var pc = new p(),
  ...
  ub = new p();
function Ec(e, i, c) {
  let o = e.encoding.exaggeration,
    u = e.encoding.exaggerationRelativeHeight,
    b = Ja.getHeight(e.minimumHeight, o, u),
    g = Ja.getHeight(e.maximumHeight, o, u),
    w = i.project(Y.fromRadians(e.rectangle.west, e.rectangle.south, 0, xc), pc),
    v = i.project(Y.fromRadians(e.rectangle.east, e.rectangle.north, 0, Ic), yc),
    x = g - b,
    j = p.fromElements(v.x - w.x, v.y - w.y, x > 0 ? x : 1, vc),
    A = p.fromElements(w.x + j.x * 0.5, w.y + j.y * 0.5, b + j.z * 0.5, Ac);
  return (
    J.fromTranslation(A, c),
    J.setScale(c, j, c),
    J.multiply(Oa.SWIZZLE_3D_TO_2D_MATRIX, c, c),
    c
  );
}
Ua.prototype.pick = function (e, i, c, o) {
  let u = this._terrainPicker.rayIntersect(e, this.getTransform(c, o), i, c, o);
  return ((this._lastPickSceneMode = c), u);
};
Ua.prototype.updateExaggeration = function (e, i) {
  ((this._terrainPicker._vertices = this.vertices),
    (this._terrainPicker.needsRebuild = !0),
    (this._lastPickSceneMode = void 0));
};
Ua.prototype.updateSceneMode = function (e) {
  ((this._terrainPicker.needsRebuild = !0), (this._lastPickSceneMode = void 0));
};
var wb = Ua;
var pb = {},
  Nc = {
...
pb.createMesh = async function (e) {
  e = e ?? fb.EMPTY_OBJECT;
  let {
    exaggeration: i = 1,
    exaggerationRelativeHeight: c = 0,
    hasVertexNormals: o,
    hasWebMercatorT: u,
    gltf: b,
    minimumHeight: g,
  ...
  (T.typeOf.object("options.ellipsoid", e.ellipsoid),
    T.typeOf.object("options.rectangle", e.rectangle),
    T.typeOf.bool("options.hasVertexNormals", o),
    T.typeOf.bool("options.hasWebMercatorT", u),
    T.typeOf.object("options.gltf", b),
    T.typeOf.number("options.minimumHeight", g),
    T.typeOf.number("options.maximumHeight", w),
    T.typeOf.object("options.boundingSphere", e.boundingSphere),
    T.typeOf.object("options.orientedBoundingBox", e.orientedBoundingBox),
    T.typeOf.object("options.horizonOcclusionPoint", e.horizonOcclusionPoint),
    T.typeOf.number("options.skirtHeight", v));
  let j = i !== 1,
    A = pa.clone(e.boundingSphere, new pa()),
    F = ra.clone(e.orientedBoundingBox, new ra()),
    k = p.clone(e.horizonOcclusionPoint, new p()),
    s = Ea.clone(e.ellipsoid, new Ea()),
    h = xa.clone(e.rectangle, new xa());
  ...
  let a = h.west,
    ...
    m = xa.center(h, Hc);
  m.height = 0.5 * (g + w);
  let y = Y.toCartesian(m, s, Fc),
    I = Oa.eastNorthUpToFixedFrame(y, s, Mc),
    H = J.inverseTransformation(I, zc),
    E = J.unpack(b.nodes[0].matrix, 0, Kc);
  E = J.multiply(Kb.Y_UP_TO_Z_UP, E, E);
  let N = pe(b, o, Nc),
    z = Fa.getSkirtVertexCount(
      N.edgeIndicesWest,
      N.edgeIndicesSouth,
      N.edgeIndicesEast,
      N.edgeIndicesNorth,
    ...
    U = B + z,
    C = D.length,
    O = Fa.getSkirtIndexCountWithFilledCorners(z),
    G = U <= 65535 ? Uint16Array : Uint32Array,
    W = new G(C + O);
  W.set(D);
  let S = new G(N.edgeIndicesWest),
    _ = new G(N.edgeIndicesSouth),
    V = new G(N.edgeIndicesEast),
    q = new G(N.edgeIndicesNorth),
    P = new G(S).sort(),
    aa = new G(_).sort(),
    X = new G(V).sort(),
    fa = new G(q).sort(),
    ba = Ia.geodeticLatitudeToMercatorAngle(d),
    ga = 1 / (Ia.geodeticLatitudeToMercatorAngle(f) - ba),
    ia = p.fromElements(
    ...
    la = new Ha(A.center, void 0, void 0, void 0, void 0, o, u, j, i, c),
    oa = la.stride,
    ca = new Float32Array(U * oa),
    ea = 0;
  for (let Q = 0; Q < B; Q++) {
    let va = p.unpack(K, Q * 3, Rc),
      sa = J.multiplyByPoint(E, va, Oc),
      Pa = Y.fromCartesian(sa, s, Cc),
      { longitude: _a, latitude: za, height: ka } = Pa,
      ja = (_a - a) / r,
      ua = (za - d) / l;
    ((ja = L.clamp(ja, 0, 1)),
      (ua = L.clamp(ua, 0, 1)),
      Ra(P, Q, Za) >= 0 ? (ja = 0) : Ra(X, Q, Za) >= 0 && (ja = 1),
      Ra(aa, Q, Za) >= 0 ? (ua = 0) : Ra(fa, Q, Za) >= 0 && (ua = 1));
    let qa = R.fromElements(ja, ua, Jc),
      Ka;
    if (o) {
      let na = p.unpack(M, Q * 3, Ga);
      ((na = J.multiplyByPointAsVector(E, na, Ga)),
        (na = p.normalize(na, Ga)),
        (Ka = rb.octEncode(na, Tc)));
    }
    let wa;
    u && (wa = (Ia.geodeticLatitudeToMercatorAngle(za) - ba) * ga);
    let Wa;
    (j && (Wa = s.geodeticSurfaceNormal(sa, Uc)), (ea = la.encode(ca, ea, sa, qa, ka, Ka, wa, Wa)));
    let Sa = J.multiplyByPoint(H, sa, Gc);
    ((ia = p.minimumByComponent(Sa, ia, ia)), (ha = p.maximumByComponent(Sa, ha, ha)));
  }
  let da = new wb(
    p.clone(la.center, new p()),
    ca,
    W,
    C,
    B,
  ...
  return (Xb(da, h, s, ia, ha, I, H, v), Promise.resolve(da));
};
var Pc = new R(),
  qc = new R(),
  Wc = new Array(6),
  ...
  ke = new p();
function je(e) {
  let i = e.meshes[0].primitives[0],
    c = e.accessors[i.attributes.POSITION],
    o = e.bufferViews[c.bufferView],
    u = c.count,
    b = o.extensions ? o.extensions.EXT_meshopt_compression : void 0;
  if (b === void 0) {
    let k = e.buffers[o.buffer].extras._pipeline.source;
    return new Float32Array(
      k.buffer,
      k.byteOffset + (o.byteOffset ?? 0) + (c.byteOffset ?? 0),
      u * 3,
    );
  }
  let g = e.buffers[b.buffer].extras._pipeline.source,
    w = new Uint8Array(
      g.buffer,
      g.byteOffset + (b.byteOffset ?? 0) + (c.byteOffset ?? 0),
      b.byteLength,
    ),
    v = b.byteStride,
    x = v === 4 ? Uint8Array : Uint16Array,
    j = new x(u * 4);
  Ma.decodeVertexBuffer(new Uint8Array(j.buffer), u, v, w);
  let A = (1 << (j.BYTES_PER_ELEMENT * 8)) - 1,
...
function ue(e) {
  let i = e.meshes[0].primitives[0],
    c = e.accessors[i.attributes.NORMAL],
    o = e.bufferViews[c.bufferView],
    u = c.count,
    b = o.extensions ? o.extensions.EXT_meshopt_compression : void 0;
  if (b === void 0) {
    let A = e.buffers[o.buffer].extras._pipeline.source;
    return new Float32Array(
      A.buffer,
      A.byteOffset + (o.byteOffset ?? 0) + (c.byteOffset ?? 0),
      u * 3,
    );
  }
  let g = e.buffers[b.buffer].extras._pipeline.source,
    ...
    v = b.byteStride,
    x = new Int8Array(u * v);
  Ma.decodeVertexBuffer(new Uint8Array(x.buffer), u, v, w);
  let j = new Float32Array(u * 3);
  for (let A = 0; A < u; A++) {
    let F = Math.max(x[A * 4 + 0] / 127, -1),
      k = Math.max(x[A * 4 + 1] / 127, -1),
      s = 1 - (Math.abs(F) + Math.abs(k));
    if (s < 0) {
      let n = F,
        t = k;
      ((F = (1 - Math.abs(t)) * L.signNotZero(n)), (k = (1 - Math.abs(n)) * L.signNotZero(t)));
    }
    let h = Ga;
    ((h.x = F),
      (h.y = k),
...
function we(e) {
  let i = e.meshes[0].primitives[0],
    c = e.accessors[i.indices],
    o = e.bufferViews[c.bufferView],
    u = c.count,
    b = c.componentType === tb.UNSIGNED_SHORT ? Uint16Array : Uint32Array,
    g = o.extensions ? o.extensions.EXT_meshopt_compression : void 0;
  if (g === void 0) {
    let j = e.buffers[o.buffer].extras._pipeline.source;
    return new b(j.buffer, j.byteOffset + (o.byteOffset ?? 0) + (c.byteOffset ?? 0), u);
  }
  let w = e.buffers[g.buffer].extras._pipeline.source,
    v = new Uint8Array(
      w.buffer,
      w.byteOffset + (g.byteOffset ?? 0) + (c.byteOffset ?? 0),
      g.byteLength,
    ),
    x = new b(u);
  return (Ma.decodeIndexBuffer(new Uint8Array(x.buffer), u, g.byteStride, v), x);
}
function $a(e, i) {
  let c = e.meshes[0].primitives[0],
    o = e.accessors[c.extensions.CESIUM_tile_edges[i]],
    u = e.bufferViews[o.bufferView],
    b = o.count,
    g = o.componentType === tb.UNSIGNED_SHORT ? Uint16Array : Uint32Array,
    w = u.extensions ? u.extensions.EXT_meshopt_compression : void 0;
  if (w === void 0) {
    let F = e.buffers[u.buffer].extras._pipeline.source;
    return new g(F.buffer, F.byteOffset + (u.byteOffset ?? 0) + (o.byteOffset ?? 0), b);
  }
  let v = e.buffers[w.buffer].extras._pipeline.source,
    x = new Uint8Array(
      v.buffer,
      v.byteOffset + (w.byteOffset ?? 0) + (o.byteOffset ?? 0),
      w.byteLength,
    ),
    j = new g(b),
    A = w.byteStride;
  return (Ma.decodeIndexSequence(new Uint8Array(j.buffer), b, A, x), j);
}
function pe(e, i, c) {
  return (
    (c.positions = je(e)),
    (c.normals = i ? ue(e) : void 0),
    (c.indices = we(e)),
    (c.edgeIndicesWest = $a(e, "left")),
    (c.edgeIndicesSouth = $a(e, "bottom")),
    (c.edgeIndicesEast = $a(e, "right")),
    (c.edgeIndicesNorth = $a(e, "top")),
    c
  );
}
pb.upsampleMesh = function (e) {
  e = e ?? fb.EMPTY_OBJECT;
  let {
    isEastChild: i,
    isNorthChild: c,
    parentMinimumHeight: o,
    parentMaximumHeight: u,
    skirtHeight: b,
  } = e;
  (T.typeOf.bool("options.isEastChild", i),
    T.typeOf.bool("options.isNorthChild", c),
    T.typeOf.object("options.parentVertices", e.parentVertices),
    T.typeOf.object("options.parentIndices", e.parentIndices),
    T.typeOf.number("options.parentVertexCountWithoutSkirts", e.parentVertexCountWithoutSkirts),
    T.typeOf.number("options.parentIndexCountWithoutSkirts", e.parentIndexCountWithoutSkirts),
    T.typeOf.number("options.parentMinimumHeight", o),
    T.typeOf.number("options.parentMaximumHeight", u),
    T.typeOf.object("options.parentEncoding", e.parentEncoding),
    T.typeOf.object("options.rectangle", e.rectangle),
    T.typeOf.number("options.skirtHeight", b),
    T.typeOf.object("options.ellipsoid", e.ellipsoid));
  let g = e.parentIndexCountWithoutSkirts,
    w = e.parentIndices,
    v = e.parentVertexCountWithoutSkirts,
    x = e.parentVertices,
    j = Ha.clone(e.parentEncoding, new Ha()),
    A = j.hasVertexNormals,
    F = j.hasWebMercatorT,
    k = j.exaggeration,
    s = j.exaggerationRelativeHeight,
    n = k !== 1,
    t = xa.clone(e.rectangle, new xa()),
    a = Ea.clone(e.ellipsoid),
    d = [],
    f = [],
    r = [],
    l = [],
    ...
    I = [],
    H = [];
  De(i, c, g, w, v, x, j, l, m, y, I, H, d, r, f);
  let E = xa.center(t, Zc);
  E.height = 0.5 * (o + u);
  let N = Y.toCartesian(E, a, $c),
    z = d.length,
    K = new Ha(N, void 0, void 0, void 0, void 0, A, F, n, k, s),
    M = K.stride,
    D = Fa.getSkirtVertexCount(m, y, I, H),
    B = z + D,
    U = l.length,
    C = Fa.getSkirtIndexCountWithFilledCorners(D),
    O = U + C,
    G = B <= 65535 ? Uint16Array : Uint32Array,
    W = new G(O);
  W.set(l);
  let S = new G(m),
    _ = new G(y),
    V = new G(I),
    q = new G(H),
    P = new Float32Array(B * M),
    aa = 0,
    X = Oa.eastNorthUpToFixedFrame(N, a, te),
    fa = J.inverseTransformation(X, re),
    ba = t.west,
    ta = t.east,
    ga = t.south,
    ia = t.north,
    ha = Ia.geodeticLatitudeToMercatorAngle(ga),
    oa = 1 / (Ia.geodeticLatitudeToMercatorAngle(ia) - ha),
    ca = Number.POSITIVE_INFINITY,
    ea = Number.NEGATIVE_INFINITY,
    da = p.fromElements(
      Number.POSITIVE_INFINITY,
      Number.POSITIVE_INFINITY,
      Number.POSITIVE_INFINITY,
  ...
  for (let ka = 0; ka < z; ka++) {
    let ja = d[ka],
      ua = w[ja * 3 + 0],
      qa = w[ja * 3 + 1],
      Ka = w[ja * 3 + 2],
      wa = ge;
    ((wa.x = f[ka * 2 + 0]), (wa.y = f[ka * 2 + 1]));
    let Wa = wa.x,
      Sa = wa.y,
      na = r[ka * 2 + 0],
      Da = r[ka * 2 + 1],
      Xa = 1 - na - Da,
      Vb = j.decodeHeight(x, ua),
      Lb = j.decodeHeight(x, qa),
      Yb = j.decodeHeight(x, Ka),
      Va = Vb * na + Lb * Da + Yb * Xa;
    ((ca = Math.min(Va, ca)), (ea = Math.max(Va, ea)));
    let Qb = L.lerp(ba, ta, Wa),
      vb = L.lerp(ga, ia, Sa),
      Zb = Y.fromRadians(Qb, vb, Va, ae),
      ab = Y.toCartesian(Zb, a, be),
      Ab = J.multiplyByPoint(fa, ab, ee);
    ((da = p.minimumByComponent(Ab, da, da)), (Q = p.maximumByComponent(Ab, Q, Q)));
    let Eb;
    if (A) {
      let La = j.decodeNormal(x, ua, Lc),
        bb = j.decodeNormal(x, qa, Yc),
        cb = j.decodeNormal(x, Ka, Qc),
        eb = p.fromElements(
          La.x * na + bb.x * Da + cb.x * Xa,
          La.y * na + bb.y * Da + cb.y * Xa,
          La.z * na + bb.z * Da + cb.z * Xa,
          Pb,
        );
      ((eb = p.normalize(eb, Pb)), (Eb = rb.octEncode(eb, se)));
    }
    let Nb;
    F && (Nb = (Ia.geodeticLatitudeToMercatorAngle(vb) - ha) * oa);
    let Hb;
    (n && (Hb = a.geodeticSurfaceNormal(ab, ke)), (aa = K.encode(P, aa, ab, wa, Va, Eb, Nb, Hb)));
  }
  let va = ra.fromRectangle(t, ca, ea, a, me),
    sa = pa.fromVertices(P, K.center, M, oe),
    _a = new zb(a).computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid(
      K.center,
      P,
      M,
      K.center,
  ...
  return (Xb(za, t, a, da, Q, X, fa, b), za);
};
function Xb(e, i, c, o, u, b, g, w) {
  let { encoding: v } = e,
    x = v.stride,
    j = e.vertices,
    { hasVertexNormals: A, hasWebMercatorT: F, exaggeration: k, exaggerationRelativeHeight: s } = v,
    n = k !== 1,
    t = e.vertexCountWithoutSkirts,
    a = t * x,
    d = j.length / x,
    f = d - t,
    r = e.indices,
    l = e.indexCountWithoutSkirts,
    m = e.westIndicesSouthToNorth,
    y = e.southIndicesEastToWest,
    I = e.eastIndicesNorthToSouth,
    H = e.northIndicesWestToEast;
  Fa.addSkirtIndicesWithFilledCorners(m, y, I, H, t, r, l);
  let E = 0,
    N = E + m.length,
    z = N + y.length,
    K = z + I.length,
  ...
  for (let V = 0; V < f; V++) {
    let q;
    for (q = 0; q < 3 && !(V < D[q + 1]); q++);
    let P = M[q][V - D[q]],
      aa = v.decodeTextureCoordinates(j, P, Gb),
      X = 1e-4,
      fa = aa.x + B[q] * X,
      ba = aa.y + U[q] * X,
      ta = L.lerp(i.west, i.east, fa),
      ga = L.clamp(L.lerp(i.south, i.north, ba), -L.PI_OVER_TWO, +L.PI_OVER_TWO),
      ha = v.decodeHeight(j, P) - w,
      la = Y.fromRadians(ta, ga, ha, _c),
      oa = Y.toCartesian(la, c, Ub),
      ca;
    A && (ca = v.getOctEncodedNormal(j, P, qb));
    let ea;
    F && (ea = v.decodeWebMercatorT(j, P));
    let da;
    (n && (da = c.geodeticSurfaceNormal(oa, Wb)), (a = v.encode(j, a, oa, aa, ha, ca, ea, da)));
    let Q = J.multiplyByPoint(g, oa, ce);
    (p.minimumByComponent(Q, C, C), p.maximumByComponent(Q, O, O));
  }
  let S = Ca.fromCorners(C, O, le),
    _ = new Ha(v.center, S, W, G, b, v.hasVertexNormals, v.hasWebMercatorT, n, k, s);
  if (v.quantization !== _.quantization) {
    let V = _,
      q = V.stride,
      P = new Float32Array(d * q),
      aa = 0;
    for (let X = 0; X < d; X++)
      aa = V.encode(
        P,
        aa,
        v.decodePosition(j, X, Ub),
        v.decodeTextureCoordinates(j, X, Gb),
        v.decodeHeight(j, X),
        v.hasVertexNormals ? v.getOctEncodedNormal(j, X, qb) : void 0,
        v.hasWebMercatorT ? v.decodeWebMercatorT(j, X) : void 0,
        v.hasGeodeticSurfaceNormals ? v.decodeGeodeticSurfaceNormal(j, X, Wb) : void 0,
      );
    ((e.vertices = P), (e.stride = q), (e.encoding = V));
  }
  return e;
}
var yb = 0,
  ...
  xe = 4,
  Ie = new p(),
  ve = [new p(), new p(), new p(), new p(), new p(), new p()],
  Ae = [new R(), new R(), new R(), new R(), new R(), new R()],
  Ee = [new p(), new p(), new p(), new p(), new p(), new p()],
  Ne = [new R(), new R(), new R(), new R(), new R(), new R()];
function Sb(e, i, c, o) {
  switch (c) {
    case yb:
      return L.sign(o.x - e.x);
    case xb:
      return L.sign(i.x - o.x);
    case Ib:
      return L.sign(o.y - e.y);
    default:
      return L.sign(i.y - o.y);
  }
}
function He(e, i, c, o, u, b) {
  let g, w, v;
  switch (c) {
    case yb:
      ((g = (e.x - o.x) / (u.x - o.x)), (w = e.x), (v = o.y + (u.y - o.y) * g));
      break;
    case xb:
      ((g = (i.x - o.x) / (u.x - o.x)), (w = i.x), (v = o.y + (u.y - o.y) * g));
      break;
    case Ib:
      ((g = (e.y - o.y) / (u.y - o.y)), (w = o.x + (u.x - o.x) * g), (v = e.y));
      break;
    default:
      ((g = (i.y - o.y) / (u.y - o.y)), (w = o.x + (u.x - o.x) * g), (v = i.y));
      break;
  }
  return p.fromElements(w, v, g, b);
}
var Fe = {
  length: 0,
  coordinates: [new R(), new R(), new R(), new R(), new R(), new R()],
  barycentricCoordinates: [new p(), new p(), new p(), new p(), new p(), new p()],
};
function Me(e, i, c, o, u, b, g, w) {
  let v,
    x = Ae,
    j = ve,
    A = 3,
    F = Ne;
  (R.clone(u, F[0]), R.clone(b, F[1]), R.clone(g, F[2]));
  let k = Ee;
  (p.fromElements(1, 0, 0, k[0]), p.fromElements(0, 1, 0, k[1]), p.fromElements(0, 0, 1, k[2]));
  for (let s = 0; s < i; s++) {
    let h = (e + s) % xe,
      n = x,
      t = j;
    ((x = F), (j = k), (v = A), (F = n), (k = t), (A = 0));
    let a = v - 1,
      d = x[a],
      f = j[a],
      r = Sb(c, o, h, d);
    for (let l = 0; l < v; l++) {
      let m = x[l],
        ...
        I = Sb(c, o, h, m);
      if (r * I === -1) {
        let H = He(c, o, h, d, m, Ie),
          { x: E, y: N, z } = H,
          K = 1 - z,
          M = f.x * K + y.x * z,
          D = f.y * K + y.y * z,
          B = f.z * K + y.z * z;
        (R.fromElements(E, N, F[A]), p.fromElements(M, D, B, k[A]), A++);
      }
      (I >= 0 && (R.clone(m, F[A]), p.clone(y, k[A]), A++), (d = m), (f = y), (r = I));
    }
    if (A === 0) break;
  }
  w.length = A;
  for (let s = 0; s < A; s++)
    (R.clone(F[s], w.coordinates[s]), p.clone(k[s], w.barycentricCoordinates[s]));
  return w;
}
function ze(e, i, c, o, u, b, g, w) {
  return Me(e ? (i ? Ib : yb) : i ? xb : ye, 2, c, o, u, b, g, w);
}
var Ke = [[], [0], [1], [0, 1], [2], [0, 2], [1, 2], [0, 1, 2]];
function De(e, i, c, o, u, b, g, w, v, x, j, A, F, k, s) {
  let h = {},
    n = e ? 0.5 : 0,
    t = e ? 1 : 0.5,
    a = i ? 0.5 : 0,
  ...
  for (let m = 0; m < c; m += 3) {
    let y = o[m + 0],
      I = o[m + 1],
      H = o[m + 2],
      E = g.decodeTextureCoordinates(b, y, Sc),
      N = g.decodeTextureCoordinates(b, I, Xc),
      z = g.decodeTextureCoordinates(b, H, Vc),
      K = ze(e, i, f, r, E, N, z, Fe),
      M = K.length;
    if (M < 3) continue;
    let D = Wc;
    for (let O = 0; O < M; O++) {
      let G = K.barycentricCoordinates[O],
        W = G.x,
        S = G.y,
        _ = G.z,
        V = Math.ceil(W) | (Math.ceil(S) << 1) | (Math.ceil(_) << 2),
        q = Ke[V],
        P,
        aa = !1;
      if (q.length === 1) {
        let X = q[0],
          ba = o[m + X];
        ((P = h[ba]), P === void 0 && ((aa = !0), (P = l++), (h[ba] = P)));
      } else if (q.length === 2) {
        let X = q[0],
          fa = q[1],
          ba = o[m + X],
          ta = o[m + fa],
          ga = K.barycentricCoordinates[(O + M - 1) % M],
          ia = Math.ceil(ga.x) | (Math.ceil(ga.y) << 1) | (Math.ceil(ga.z) << 2),
          ha = V === ia,
          la = Math.min(ba, ta),
          oa = Math.max(ba, ta),
          ca = u + 2 * (la * u + oa),
          ...
          Q = h[ea],
          va = h[da],
          sa = !ha == (Q === void 0 || va === void 0);
        if (((P = sa ? Q : va), P === void 0)) {
          ((aa = !0), (P = l++));
          let Pa = sa ? ea : da;
          h[Pa] = P;
        }
      ...
      if (((D[O] = P), aa)) {
        let X = m / 3;
        F.push(X);
        let fa = K.coordinates[O],
          ba = (fa.x - n) / (t - n),
          ta = (fa.y - a) / (d - a);
        (s.push(ba, ta),
          k.push(W, S),
          ba === 0 ? v.push(P) : ba === 1 && j.push(P),
          ta === 0 ? x.push(P) : ta === 1 && A.push(P));
      }
    }
    let B = D[0],
      U = D[1],
      C = D[2];
    w.push(B, U, C);
    for (let O = 3; O < M; O++) ((U = C), (C = D[O]), w.push(B, U, C));
  }
  (v.sort(function (m, y) {
    return s[m * 2 + 1] - s[y * 2 + 1];
  }),
    x.sort(function (m, y) {
      return s[y * 2 + 0] - s[m * 2 + 0];
    }),
    j.sort(function (m, y) {
      return s[y * 2 + 1] - s[m * 2 + 1];
    }),
    A.sort(function (m, y) {
      return s[m * 2 + 0] - s[y * 2 + 0];
    }));
}
var nf = pb;
export { nf as a };
