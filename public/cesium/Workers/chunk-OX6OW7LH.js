...
import { a as tt } from "./chunk-SXFPISI4.js";
import { a as jt } from "./chunk-QVQR4MNN.js";
import { b as Lt } from "./chunk-Q2AGSIFJ.js";
import { a as Et } from "./chunk-4XQS6KUO.js";
import { a as j } from "./chunk-CVUC3Z4F.js";
import { a as dt, b as D, c as B, d as U } from "./chunk-VGKISNF5.js";
import { a as _t, c as ot } from "./chunk-VPJRLZMB.js";
import { a as Ut } from "./chunk-635BMVFD.js";
import { a as pt, b as H } from "./chunk-HHFPYI7Q.js";
import { a as F } from "./chunk-SSZI3JCE.js";
import { a as Mt, b as V } from "./chunk-WORPNHJT.js";
import { a as r, b as gt, c as Ot } from "./chunk-SWCW4GSU.js";
import { a as N } from "./chunk-PZM5FOOW.js";
import { a as I, b as ft } from "./chunk-3MNKUQ6L.js";
...
Nt.calculateACMR = function (t) {
  ...
  let i = e.length;
  if (i < 3 || i % 3 !== 0) throw new I("indices length must be a multiple of three.");
...
Nt.tipsify = function (t) {
  ...
  function o(C, z, q, R, G, M, J) {
    ...
    for (; Pt < q.length;) {
      ...
      (R[lt].numLiveTriangles &&
        ((_ = 0),
        G - R[lt].timeStamp + 2 * R[lt].numLiveTriangles <= z && (_ = G - R[lt].timeStamp),
        (_ > St || St === -1) && ((St = _), (Y = lt))),
        ++Pt);
    }
  ...
  if (!f(e)) throw new I("indices is required.");
  let a = e.length;
  if (a < 3 || a % 3 !== 0) throw new I("indices length must be a multiple of three.");
  if (n <= 0) throw new I("maximumIndex must be greater than zero.");
  if (s < 3) throw new I("cacheSize must be greater than two.");
  let p = 0,
    u = 0,
  ...
  let l = [],
    h;
  for (h = 0; h < p; h++) l[h] = { numLiveTriangles: 0, timeStamp: 0, vertexTriangles: [] };
  u = 0;
  let y = 0;
  for (; u < m;)
...
function It(t, e, n, s, i) {
  ((t[e++] = n), (t[e++] = s), (t[e++] = s), (t[e++] = i), (t[e++] = i), (t[e] = n));
}
function de(t) {
  let e = t.length,
    n = (e / 3) * 6,
  ...
  if (f(e)) {
    switch (t.primitiveType) {
      ...
      case D.TRIANGLE_FAN:
        ...
        break;
      default:
        throw new I("geometry.primitiveType must be TRIANGLES, TRIANGLE_STRIP, or TRIANGLE_FAN.");
    }
...
k.createLineSegmentsForVectors = function (t, e, n) {
  ...
  if (!f(t.attributes.position)) throw new I("geometry.attributes.position is required.");
  if (!f(t.attributes[e]))
    throw new I(
  ...
  return (
    ...
    new B({
      attributes: {
        position: new U({ componentDatatype: F.DOUBLE, componentsPerAttribute: 3, values: o }),
      },
...
k.reorderForPreVertexCache = function (t) {
  ...
  if (f(n)) {
    ...
    let i = n,
      ...
      d;
    for (; a < c;)
      ((d = s[i[a]]), d !== -1 ? (o[p] = d) : ((d = i[a]), (s[d] = u), (o[p] = u), ++u), ++a, ++p);
    t.indices = o;
    let m = t.attributes;
    for (let l in m)
...
k.projectTo2D = function (t, e, n, s, i) {
  ...
  if (!f(t.attributes[e]))
    throw new I(`geometry must have attribute matching the attributeName argument: ${e}.`);
  if (t.attributes[e].componentDatatype !== F.DOUBLE)
    throw new I("The attribute componentDatatype must be ComponentDatatype.DOUBLE.");
  ...
  for (let d = 0; d < a.length; d += 3) {
    ...
    if (!f(l)) throw new I(`Could not project point (${m.x}, ${m.y}, ${m.z}) to 2D.`);
...
k.encodeAttribute = function (t, e, n, s) {
  ...
  for (let d = 0; d < o; ++d) (jt.encode(c[d], zt), (a[d] = zt.high), (p[d] = zt.low));
  let u = i.componentsPerAttribute;
  return (
    (t.attributes[n] = new U({ componentDatatype: F.FLOAT, componentsPerAttribute: u, values: a })),
    (t.attributes[s] = new U({ componentDatatype: F.FLOAT, componentsPerAttribute: u, values: p })),
    delete t.attributes[e],
    t
  );
};
...
function Dt(t, e) {
  if (f(e)) {
    let n = e.values,
      s = n.length;
    for (let i = 0; i < s; i += 3) (r.unpack(n, i, $), H.multiplyByPoint(t, $, $), r.pack($, n, i));
  }
}
function qt(t, e) {
  if (f(e)) {
    let n = e.values,
      s = n.length;
    for (let i = 0; i < s; i += 3)
      (r.unpack(n, i, $), gt.multiplyByVector(t, $, $), ($ = r.normalize($, $)), r.pack($, n, i));
  }
}
var wt = new H(),
  vt = new gt();
...
function Rt(t, e) {
  ...
  for (i = 1; i < n; ++i) {
    ...
    if (f(t[i][e].indices) !== p)
      throw new I("All instance geometries must have an indices or not have one.");
  ...
  for (s in d)
    if (d.hasOwnProperty(s))
      for (m = d[s].values, o = 0, i = 0; i < n; ++i)
        for (l = t[i][e].attributes[s].values, h = l.length, c = 0; c < h; ++c) m[o++] = l[c];
  let y;
  if (p) {
    let x = 0;
    for (i = 0; i < n; ++i) x += t[i][e].indices.length;
    let w = B.computeNumberOfVertices(new B({ attributes: d, primitiveType: D.POINTS })),
...
k.combineInstances = function (t) {
  if (!f(t) || t.length < 1)
    throw new I("instances is required and must have length greater than zero.");
  let e = [],
    n = [],
    s = t.length;
  for (let c = 0; c < s; ++c) {
  ...
  return (
    ...
    n.length > 0 &&
      (i.push(Rt(n, "westHemisphereGeometry")), i.push(Rt(n, "eastHemisphereGeometry"))),
    i
  );
};
var Z = new r(),
...
k.computeNormal = function (t) {
  ...
  if (t.indices.length < 2 || t.indices.length % 3 !== 0)
    throw new I("geometry.indices length must be greater than 0 and be a multiple of 3.");
  ...
  for (u = 0; u < i; u++) {
    ...
    if (((l = o[u]), r.clone(r.ZERO, Z), l.count > 0)) {
      ...
      r.equalsEpsilon(r.ZERO, Z, N.EPSILON10) && r.clone(a[p[l.indexOffset]], Z);
    }
...
k.computeTangentAndBitangent = function (t) {
  ...
  if (!f(e.st) || !f(e.st.values)) throw new I("geometry.attributes.st.values is required.");
...
k.compressVertices = function (t) {
  ...
  if (f(e)) {
    ...
    for (n = 0; n < s; ++n) {
      ...
      ((yt = tt.octEncodeInRange(W, 65535, yt)), (O[L++] = yt.x), (O[L++] = yt.y));
    }
    return (
  ...
  let A = new Float32Array(x),
    E = 0;
  for (n = 0; n < s; ++n) {
    a && (V.fromArray(h, n * 2, ht), (A[E++] = tt.compressTextureCoordinates(ht)));
    let P = n * 3;
    o && f(y) && f(v)
      ? (r.fromArray(l, P, W),
        r.fromArray(y, P, Qt),
...
function Ae(t) {
  ...
  if (e % 3 !== 0) throw new I("The number of vertices must be a multiple of three.");
...
function Pe(t) {
  ...
  if (e % 2 !== 0) throw new I("The number of vertices must be a multiple of 2.");
  let n = j.createTypedArray(e, e);
  for (let s = 0; s < e; ++s) n[s] = s;
  return ((t.indices = n), t);
}
...
function Oe(t) {
  ...
  let s = 2;
  for (let i = 2; i < e; ++i) ((n[s++] = i - 1), (n[s++] = i));
  return ((n[s++] = e - 1), (n[s] = 0), (t.indices = n), (t.primitiveType = D.LINES), t);
}
function Le(t) {
  switch (t.primitiveType) {
    case D.TRIANGLE_FAN:
...
function Ne(t, e, n) {
  ...
  o === 1
    ? ((a[1] = 3),
      ...
      (a[8] = 5),
      s
        ? (X(t, e, et, it), X(t, n, nt, st), (a[0] = 0), (a[3] = 1), (a[4] = 2), (a[6] = 1))
        : i
          ? (X(e, n, et, it), X(e, t, nt, st), (a[0] = 1), (a[3] = 2), (a[4] = 0), (a[6] = 2))
          : c && (X(n, t, et, it), X(n, e, nt, st), (a[0] = 2), (a[3] = 0), (a[4] = 1), (a[6] = 0)))
    : o === 2 &&
      ((a[2] = 4),
      (a[4] = 4),
      (a[5] = 3),
      ...
      s
        ? i
          ? c || (X(n, t, et, it), X(n, e, nt, st), (a[0] = 0), (a[1] = 1), (a[3] = 0), (a[6] = 2))
          : (X(e, n, et, it), X(e, t, nt, st), (a[0] = 2), (a[1] = 0), (a[3] = 2), (a[6] = 1))
        : (X(t, e, et, it), X(t, n, nt, st), (a[0] = 1), (a[1] = 2), (a[3] = 1), (a[6] = 0)));
  let p = Vt.positions;
  return (
    (p[0] = t),
    (p[1] = e),
    (p[2] = n),
    (p.length = 3),
    (o === 1 || o === 2) && ((p[3] = et), (p[4] = nt), (p[5] = it), (p[6] = st), (p.length = 7)),
    Vt
  );
}
function ne(t, e) {
...
function Ft(t, e, n) {
  ...
  ((e = ne(e, s)),
    ...
    f(n) && !f(e)
      ...
      : !f(n) && f(e)
        ? (t.geometry = e)
        : ((t.westHemisphereGeometry = e), (t.eastHemisphereGeometry = n), (t.geometry = void 0)));
}
function kt(t, e) {
  let n = new t(),
    s = new t(),
  ...
  return function (c, o, a, p, u, d, m, l) {
    ...
    (t.multiplyByScalar(h, p.x, h), t.multiplyByScalar(y, p.y, y), t.multiplyByScalar(v, p.z, v));
    let b = t.add(h, y, h);
...
function xt(t, e, n, s, i, c, o, a, p, u, d, m, l, h, y, v) {
  ...
  if (f(w)) {
    if ((f(c) && At(t, e, n, w, c, m.normal.values, v, !0), f(u))) {
      ...
      (r.multiplyByScalar(A, w.x, A), r.multiplyByScalar(E, w.y, E), r.multiplyByScalar(P, w.z, P));
      let O;
...
function ie(t) {
  ...
  A.length = s.length / 3;
  let E = [];
  for (E.length = s.length / 3, w = 0; w < A.length; ++w) ((A[w] = -1), (E[w] = -1));
  let P = d.length;
  for (w = 0; w < P; w += 3) {
    let O = d[w],
      L = d[w + 1],
    ...
    if (f(q) && q.positions.length > 3) {
      ...
      (f(q) && ((T = q.positions[0]), (C = q.positions[1]), (z = q.positions[2])),
        T.y < 0
          ? ((v = y.attributes), (b = y.indices), (S = A))
          : ((v = h.attributes), (b = h.indices), (S = E)),
        (x = K(v, b, S, d, w, T)),
...
function se(t) {
  ...
  d.length = s.length / 3;
  let m = [];
  for (m.length = s.length / 3, p = 0; p < d.length; ++p) ((d[p] = -1), (m[p] = -1));
  for (p = 0; p < u; p += 2) {
    let l = c[p],
      h = c[p + 1],
      ...
      b;
    (Math.abs(y.y) < N.EPSILON6 && (y.y < 0 ? (y.y = -N.EPSILON6) : (y.y = N.EPSILON6)),
      Math.abs(v.y) < N.EPSILON6 && (v.y < 0 ? (v.y = -N.EPSILON6) : (v.y = N.EPSILON6)));
    let S = o.attributes,
      x = o.indices,
      w = m,
      A = a.attributes,
...
function Ue(t) {
  ...
  for (m = 0; m < v; m += 4) {
    ...
    if (Math.abs(x.y) < Tt)
      for (
        x.y = Tt * (w.y < 0 ? -1 : 1), s[m * 3 + 1] = x.y, s[(m + 1) * 3 + 1] = x.y, l = b * 3;
        l < b * 3 + 12;
        l += 3
      )
        ((i[l] = s[m * 3]), (i[l + 1] = s[m * 3 + 1]), (i[l + 2] = s[m * 3 + 2]));
    if (Math.abs(w.y) < Tt)
      for (
        w.y = Tt * (x.y < 0 ? -1 : 1),
          s[(m + 2) * 3 + 1] = w.y,
        ...
        ((c[l] = s[(m + 2) * 3]), (c[l + 1] = s[(m + 2) * 3 + 1]), (c[l + 2] = s[(m + 2) * 3 + 2]));
    let A = u.attributes,
      E = u.indices,
      P = d.attributes,
      O = d.indices,
    ...
    if (f(L)) {
      ...
      x.y < 0 &&
        (r.negate(g, g), (A = d.attributes), (E = d.indices), (P = u.attributes), (O = u.indices));
      let T = r.add(L, g, Me);
      ...
      let g, T;
      for (
        x.y < 0 ? ((g = d.attributes), (T = d.indices)) : ((g = u.attributes), (T = u.indices)),
...
k.splitLongitude = function (t) {
  ...
  if (
    f(n) &&
    (n.center.x - n.radius > 0 || ot.intersectPlane(n, Et.ORIGIN_ZX_PLANE) !== Ut.INTERSECTING)
  )
    return t;
  ...
  else (Le(e), e.primitiveType === D.TRIANGLES ? ie(t) : e.primitiveType === D.LINES && se(t));
  return t;
};
var Pn = k;
export { Pn as a };
