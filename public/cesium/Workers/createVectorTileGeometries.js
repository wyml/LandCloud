...
import { a as z } from "./chunk-IFUEQIXQ.js";
import "./chunk-7PSAWR6C.js";
import { a as H } from "./chunk-LHAZNKMD.js";
import { a as Y } from "./chunk-RCKN2G6K.js";
import { a as j } from "./chunk-3SXIKFFK.js";
...
import { b as d } from "./chunk-HHFPYI7Q.js";
...
function R(e, c, n, i, r) {
  ...
  for (let w = 0; w < t; ++w) {
    ...
    for (let f = 0; f < A; f += 3) {
      ...
      (d.multiplyByPoint(k, m, m), o.subtract(m, Z, m), o.pack(m, a, V * 3 + f), (x[B++] = M));
    }
    let b = h.length;
    for (let f = 0; f < b; ++f) y[O + f] = h[f] + V;
    let g = w + D;
    ((T[g] = new J({ offset: O, count: b, color: P.fromRgba(p[M]), batchIds: [M] })),
      (I[g] = M),
      (U[g] = O),
      (v[g] = b),
...
function ae(e, c, n) {
  ...
  for (let a = 0; a < h; ++a) {
    let x = c[a];
    (P.pack(x.color, t, s), (s += P.packedLength), (t[s++] = x.offset), (t[s++] = x.count));
    let y = x.batchIds,
      I = y.length;
    t[s++] = I;
