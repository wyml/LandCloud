...
import { a as _ } from "./chunk-WNW5RVPR.js";
import { a as te } from "./chunk-HCBOUAOS.js";
import { h as Z, i as fe } from "./chunk-Y7Z6CVXH.js";
import { a as ie, b as j } from "./chunk-HHFPYI7Q.js";
import { a as se, b as ee } from "./chunk-WORPNHJT.js";
import { a as e, b as O } from "./chunk-SWCW4GSU.js";
import { a as Q } from "./chunk-PZM5FOOW.js";
import { a as le } from "./chunk-3MNKUQ6L.js";
import { f as $ } from "./chunk-J4SK6SKL.js";
var me = { ROUNDED: 0, MITERED: 1, BEVELED: 2 };
Object.freeze(me);
var G = me;
var ue = {};
function P(r, n) {
  if (!$(r)) throw new le("identifier is required.");
  $(ue[r]) || ((ue[r] = !0), console.warn(n ?? r));
}
P.geometryOutlines =
...
function v(r, n, a, o, t, c, f, l) {
  ...
  ((oe = O.fromRotationZ(S, oe)),
    (de.z = c),
    (H = j.multiplyTransformation(H, j.fromRotationTranslation(oe, de, Me), H)));
  let d = Ne;
  d[0] = f;
  for (let x = 0; x < l; x++)
...
function Ie(r, n) {
  ...
  for (let m = 1; m < a; m++) {
    ...
    let s = l.x - c,
      S = l.y - f;
    ((o[t++] = s), (o[t++] = 0), (o[t++] = S), (o[t++] = s), (o[t++] = 0), (o[t++] = S));
  }
...
function ge(r, n) {
  let a = r.length,
    ...
    c = n.x + n.width / 2,
    f = n.y + n.height / 2;
  for (let l = 0; l < a; l++) ((o[t++] = r[l].x - c), (o[t++] = 0), (o[t++] = r[l].y - f));
  return o;
}
var ye = new Z(),
  we = new e(),
...
function xe(r, n, a, o, t, c, f, l, m, s) {
  let S = e.angleBetween(e.subtract(n, r, I), e.subtract(a, r, W)),
    ...
    x;
  t
    ? (x = O.fromQuaternion(Z.fromAxisAngle(e.negate(r, I), S / (d + 1), ye), pe))
...
R.computePositions = function (r, n, a, o, t) {
  ...
  let N = f[0],
    A = f[1];
  (t && (D = v(p, u, S, D, c, N + d, 1, 1)), (T = e.clone(p, T)), (p = M), (b = e.negate(y, b)));
  let V, F;
  for (let U = 1; U < i - 1; U++) {
    let ae = t ? 2 : 1;
    if (((M = r[U + 1]), p.equals(M))) {
      he("Positions are too close and are considered equivalent with rounding error.");
      continue;
    }
    ((y = e.subtract(M, p, y)), (y = e.normalize(y, y)), (E = c.geodeticSurfaceNormal(p, E)));
