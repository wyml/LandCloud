...
import { a as mt } from "./chunk-YXV5TEKN.js";
import { a as P } from "./chunk-5LV3J43L.js";
import { a as ht } from "./chunk-RCKN2G6K.js";
import { a as ft } from "./chunk-ZBAXXYBT.js";
import { a as ot, c as st } from "./chunk-WORPNHJT.js";
import { a as g, b as it } from "./chunk-SWCW4GSU.js";
import { a as M } from "./chunk-PZM5FOOW.js";
import { b as lt } from "./chunk-3MNKUQ6L.js";
import { d as pt, f as h } from "./chunk-J4SK6SKL.js";
var at = pt(mt(), 1);
function xt(n) {
  return (
    lt.defined("value", n),
    n <= 0.04045 ? n * 0.07739938080495357 : Math.pow((n + 0.055) * 0.9478672985781991, 2.4)
  );
}
var k = xt;
var ut;
...
function yt(n, t, e) {
  for (let o = 0; o < e.length; o++) {
    ...
    if (i.x > a.west && i.x < a.east && i.y > a.south && i.y < a.north) return It(i.x, i.y, e[o]);
  }
  return 0;
}
    ...
    c = [
      ...
      function () {
        ((r = new n.DracoInt8Array(i)),
          t.GetAttributeInt8ForAllPoints(e, o, r) || console.error("Bad stream"));
      ...
      function () {
        ((r = new n.DracoInt8Array(i)),
          t.GetAttributeUInt8ForAllPoints(e, o, r) || console.error("Bad stream"));
      ...
      function () {
        ((r = new n.DracoInt16Array(i)),
          t.GetAttributeInt16ForAllPoints(e, o, r) || console.error("Bad stream"));
      ...
      function () {
        ((r = new n.DracoInt32Array(i)),
          t.GetAttributeInt32ForAllPoints(e, o, r) || console.error("Bad stream"));
...
function Ht(n) {
  ...
  (h(n.geoidDataList) &&
    ...
    At(t.vertexCount, t.positions, t.scale_x, t.scale_y, n.cartographicCenter, n.geoidDataList, !1),
    Lt(
      t.vertexCount,
      t.positions,
      t.normals,
    ...
    h(t.uv0s) && h(t["uv-region"]) && Ot(t.vertexCount, t.uv0s, t["uv-region"]));
  let e;
  ...
  if (n.calculateNormals) {
    let r = St(t.vertexCount, t.indices, t.positions, t.normals, t.uv0s, t.colors, e);
    h(r.normals) &&
      ((t.normals = r.normals),
      h(r.vertexCount) &&
  ...
  let o = vt(t.vertexCount, t.indices, t.positions, t.normals, t.uv0s, t.colors, e, n),
    a = {
...
async function Xt(n, t) {
  ...
  return (
    h(e) && h(e.wasmBinaryFile) ? (ut = await (0, at.default)(e)) : (ut = await (0, at.default)()),
    !0
  );
}
function Yt(n, t) {
